  ...
  package Model
    ...
    package Kofranek2013
      model NonPulsatileCirculation
        ...
        replaceable Parts.HeartPump rightHeart(StarlingSlope(
              displayUnit="ml/(mmHg.s)") = 1.2503526469347e-07)
          annotation (Placement(transformation(extent={{-72,-10},{-48,16}})));
        replaceable Parts.HeartPump leftHeart(StarlingSlope(
    ...
    package Guyton
      ...
      model PulmonaryCirculation
        ...
        Physiolibrary.Hydraulic.Components.ElasticVessel pulmonaryVeinsAndLeftAtrium(volume_start(displayUnit = "l") = 0.0004, ZeroPressureVolume(displayUnit = "l") = 0.0004, Compliance(displayUnit = "l/mmHg") = 7.5006157584566e-008) annotation(Placement(transformation(extent = {{12, 68}, {32, 88}})));
        Physiolibrary.Hydraulic.Components.ElasticVessel pulmonaryArteries(ZeroPressureVolume(displayUnit = "l") = 0.00030625, Compliance(displayUnit = "l/mmHg") = 3.6002955640592e-008, volume_start(displayUnit = "l") = 0.00038) annotation(Placement(transformation(extent = {{-54, 68}, {-34, 88}})));
        Physiolibrary.Hydraulic.Components.Conductor pulmonary(Conductance(displayUnit = "l/(mmHg.min)") = 4.1665920538226e-008) annotation(Placement(transformation(extent = {{-22, 68}, {-2, 88}})));
      equation
        connect(pulmonaryArteries.q_in, pulmonary.q_in) annotation(Line(points = {{-44, 78}, {-22, 78}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        ...
        connect(q_in, pulmonaryArteries.q_in) annotation(Line(points = {{-100, 0}, {-72, 0}, {-72, 78}, {-44, 78}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(q_out, pulmonaryVeinsAndLeftAtrium.q_in) annotation(Line(points = {{100, 0}, {62, 0}, {62, 78}, {22, 78}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
      ...
      model Heart
        ...
        Physiolibrary.Hydraulic.Sensors.PressureMeasure pressureMeasure annotation(Placement(transformation(extent = {{-68, 36}, {-48, 56}})));
        Physiolibrary.Hydraulic.Components.Pump rightHeart(useSolutionFlowInput = true) annotation(Placement(transformation(extent = {{-46, 18}, {-26, 38}})));
        Physiolibrary.Types.Constants.VolumeFlowRateConst RNormalCO(k(displayUnit = "l/min") = 8.333333333333301e-005) annotation(Placement(transformation(extent = {{-50, 50}, {-42, 58}})));
        Physiolibrary.Hydraulic.Sensors.PressureMeasure pressureMeasure1 annotation(Placement(transformation(extent = {{2, 36}, {22, 56}})));
        Physiolibrary.Hydraulic.Components.Pump leftHeart(useSolutionFlowInput = true) annotation(Placement(transformation(extent = {{26, 16}, {46, 36}})));
        Physiolibrary.Types.Constants.VolumeFlowRateConst LNormalCO(k(displayUnit = "l/min") = 8.333333333333301e-005) annotation(Placement(transformation(extent = {{22, 52}, {30, 60}})));
        Physiolibrary.Hydraulic.Components.ElasticVessel rightAtrium(volume_start(displayUnit = "l") = 0.0001, ZeroPressureVolume(displayUnit = "l") = 0.0001, Compliance(displayUnit = "l/mmHg") = 3.7503078792283e-008) annotation(Placement(transformation(extent = {{-70, 18}, {-50, 38}})));
        Physiolibrary.Blocks.Factors.Spline rightStarling(data = {{-6, 0, 0}, {-3, 0.15, 0.104}, {-1, 0.52, 0.48}, {2, 1.96, 0.48}, {4, 2.42, 0.123}, {8, 2.7, 0}})
        ...
        Physiolibrary.Blocks.Factors.Spline leftStarling(data = {{-4, 0, 0}, {-1, 0.72, 0.29}, {0, 1.01, 0.29}, {3, 1.88, 0.218333}, {10, 2.7, 0}})
      ...
      equation
        connect(pressureMeasure.q_in, rightHeart.q_in) annotation(Line(points = {{-62, 40}, {-62, 28}, {-46, 28}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(rightAtrium.q_in, rightHeart.q_in) annotation(Line(points = {{-60, 28}, {-46, 28}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(RNormalCO.y, rightStarling.yBase) annotation(Line(points = {{-41, 54}, {-36, 54}, {-36, 44}}, color = {0, 0, 127}, smooth = Smooth.None));
        connect(pressureMeasure.pressure, rightStarling.u) annotation(Line(points = {{-52, 42}, {-44, 42}}, color = {0, 0, 127}, smooth = Smooth.None));
        connect(LNormalCO.y, leftStarling.yBase) annotation(Line(points = {{31, 56}, {36, 56}, {36, 44}}, color = {0, 0, 127}, smooth = Smooth.None));
        connect(pressureMeasure1.pressure, leftStarling.u) annotation(Line(points = {{18, 42}, {28, 42}}, color = {0, 0, 127}, smooth = Smooth.None));
    ...
    package Meurs
      package Parts
        model PulmonaryCirculation
          extends Cardiovascular.PulmonaryCirculation;
          Physiolibrary.Hydraulic.Components.ElasticVessel PulmonaryArteries(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 0.000106) annotation(Placement(transformation(extent={{-72,-12},
                    {-48,12}})));
          ...
          Physiolibrary.Types.Constants.PressureConst Pth(k = -533.28954966) annotation(Placement(transformation(extent={{-5,-5},
                    {5,5}},                                                                                                    rotation = 0, origin={-63,39})));
          Physiolibrary.Types.Constants.VolumeConst VPAU(k = 5e-005) annotation(Placement(                transformation(origin={-77,18},    extent={{-5,-4},
                    {5,4}},                                                                                                    rotation = 0)));
          replaceable
            Physiolibrary.Types.Constants.HydraulicElastanceToComplianceConst           EPA(k = 31064116.267695) annotation(Placement(                transformation(origin={-76,29},    extent={{-4,-3},
                    {4,3}},                                                                                                    rotation = 0)));
          replaceable
            Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst
                                                                                          RPP(k(displayUnit = "(mmHg.s)/ml") = 14665462.61565) annotation(Placement(                transformation(origin={-25,17},    extent={{-5,-3},
                    {5,3}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicElastanceToComplianceConst EPV(k = 6066168.6273825) annotation(Placement(                transformation(origin={16,28},    extent={{-6,-4},
                    {6,4}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.VolumeConst VPVU(k = 0.00035) annotation(Placement(                transformation(origin={4,18},     extent={{-6,-4},
                    {6,4}},                                                                                                    rotation = 0)));
          replaceable
            Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst
                                                                                          RLAIN(k(displayUnit = "(mmHg.s)/ml") = 399967.162245) annotation(Placement(                transformation(origin={52,24},    extent={{-6,-4},
                    {6,4}},                                                                                                    rotation = 0)));
        equation
          connect(Pth.y, PulmonaryArteries.externalPressure) annotation(Line(points={{-56.75,
                  39},{-50,39},{-50,9.6},{-50.4,9.6}},                                                                                  color={0,0,127},     smooth=Smooth.
                  None));
          connect(Pth.y, PulmonaryVeins.externalPressure) annotation(Line(points={{-56.75,
                  39},{31.6,39},{31.6,9.6}},                                                                             color={0,0,127},     smooth=Smooth.
                  None));
          connect(q_in, PulmonaryArteries.q_in) annotation(Line(points={{-100,0},{
                  -80,0},{-80,2.22045e-016},{-60,2.22045e-016}},                                                      color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
          connect(PulmonaryArteries.q_in, PulmonaryArteriesResistance.q_in) annotation(Line(points={{-60,
                  2.22045e-016},{-48.5,2.22045e-016},{-48.5,0},{-36,0}},                                                                             color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        ...
        model AtrialElastance
         ...
         annotation(Placement(transformation(extent = {{100, -10}, {120, 10}}), iconTransformation(extent = {{100, -20}, {138, 18}})));
        ...
        equation
          ...
          annotation(Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-100,-100},
                    {100,100}}),                                                                              graphics={  Rectangle(extent={{
                      -100,82},{100,-100}},                                                                                                    pattern=  LinePattern.None,
                    ...
                    fillPattern=                                                                                                    FillPattern.Solid, textString=  "%name"),
                                                                                                    Text(extent=  {{72, 4}, {102, -8}}, lineColor=
                      {0,0,255},                                                                                                    fillColor=
                      {255,255,170},
                    fillPattern=FillPattern.Solid,
                  textString="Ct")}),    Diagram(coordinateSystem(preserveAspectRatio=false,
                  extent={{-100,-100},{100,100}}), graphics));
        end AtrialElastance;
        ...
        equation
          ...
          annotation(Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-100,-100},
                    {100,100}}),                                                                              graphics={  Rectangle(extent={{
                      -98,82},{100,-100}},                                                                                                    pattern=  LinePattern.None,
                    lineThickness=                                                                                                    1, fillColor=  {255, 255, 170},
                    fillPattern=                                                                                                    FillPattern.Solid, lineColor=  {0, 0, 255}), Text(extent=  {{-82, 82}, {80, 24}}, lineColor=  {0, 0, 255},
                    lineThickness=                                                                                                    1, fillColor=  {255, 255, 170},
                    fillPattern=                                                                                                    FillPattern.Solid, textString=  "Ventricular elastance"), Line(points={{
                      -72,-34},{-62,-34},{-52,-34},{-44,8},{-18,38},{-12,14},{-6,-10},{0,
                      -32},{6,-34},{88,-34},{94,-34}},                                                                                                    color=  {0, 0, 255}, smooth=  Smooth.Bezier), Text(extent=  {{-220, -102}, {200, -120}}, lineColor=  {0, 0, 255},
                    lineThickness=                                                                                                    1, fillColor=  {255, 255, 170},
                    fillPattern=                                                                                                    FillPattern.Solid, textString=  "%name"),
                                                                                                    Text(extent=  {{96, -32}, {68, -8}}, lineColor=  {0, 0, 255}, fillColor=  {255, 255, 170},
                    fillPattern=                                                                                                    FillPattern.Solid, textString=  "Et0"), Text(extent=  {{42, -72}, {88, -84}}, lineColor=  {0, 0, 255}, fillColor=  {255, 255, 170},
                    fillPattern=                                                                                                    FillPattern.Solid, textString=  "Heart interval"),
                Text(
                  extent={{62,30},{96,8}},
                  lineColor={0,0,255},
                  lineThickness=1,
                  ...
                  fillPattern=FillPattern.Solid,
                  textString="Ct")}),                                                                                                    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics));
        ...
        model Heart
          ...
          RightHeart rightHeart annotation (Placement(visible=true, transformation(
                origin={-36,-10},
                extent={{-30,-32},{30,32}},
                rotation=0)));
        ...
        equation
          connect(leftHeart.outflow, aortaFlowMeasurement.q_in) annotation(Line(points={{7,12},{
                  7,12},{30,12}},                                                                                    thickness = 1));
          connect(rightHeart.outflow, rightHeartOutflow) annotation(Line(points={{-36,
                  15.6},{-68.5,15.6},{-68.5,20},{-100,20}},                                                                              thickness = 1));
          connect(rightHeartInflow, rightHeart.inflow) annotation(Line(points={{-100,
                  -20},{-50,-20},{-50,-10.64},{-36,-10.64}},                                                                               thickness = 1));
          connect(Pth.y, leftHeart.PTH) annotation(Line(points={{-46.5,-46},{5.38,
                  -46},{5.38,-37.2}},                                                                        color = {0, 0, 127}, smooth = Smooth.None));
          ...
          connect(rightHeart.PTH, leftHeart.PTH) annotation (Line(
              ...
              color={0,0,127},
              smooth=Smooth.None));
          annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -60}, {100, 80}}), graphics), Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
                    -60},{100,80}}),                                                                                                    graphics));
        end Heart;

        model HeartIntervals
           discrete Physiolibrary.Types.Time Tas,T0,Tvs;
           parameter Physiolibrary.Types.Time Tav = 0.01
          ...
          Physiolibrary.Types.RealIO.FrequencyInput HR "heart rate" annotation (Placement(
                transformation(extent={{-12,68},{28,108}}), iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=270,
                origin={0,80})));
        equation
        ...
        model SystemicCirculation
          extends Cardiovascular.SystemicCirculation;
          Physiolibrary.Hydraulic.Components.ElasticVessel IntraThoracicArteries(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 0.000204) annotation(Placement(transformation(extent={{-6,-6},
                    {6,6}},
                rotation=0,
                origin={84,-2})));
          Physiolibrary.Hydraulic.Components.ElasticVessel ExtrathoracicArteries(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start(displayUnit = "ml") = 0.000526) annotation(Placement(transformation(extent={{-6,-6},
                    {6,6}},
                rotation=0,
                origin={40,-2})));
          Physiolibrary.Hydraulic.Components.Inertia inertia(I(displayUnit = "mmHg.s2/ml") = 93325.6711905, volumeFlow_start(displayUnit = "ml/min") = 2.1666666666667e-005) annotation(Placement(transformation(extent={{-5,-5},
                    {5,5}},                                                                                                    rotation=180,   origin={69,-1})));
          ...
          Physiolibrary.Types.Constants.VolumeConst VETHAU(k = 0.00037)
            "unstressed volume of extrathoracic arteries"                                                             annotation(Placement(                transformation(origin={33,12.5},     extent={{-3,-2.5},
                    {3,2.5}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicElastanceToComplianceConst             EETHA(k(displayUnit = "mmHg/ml") = 74127247.40274) annotation(Placement(                transformation(origin={33,21},     extent={{-3,-3},
                    {3,3}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst             RETHA(k(displayUnit = "(mmHg.s)/ml") = 7999343.2449) annotation(Placement(                transformation(origin={49,13},     extent={{-3,-3},
                    {3,3}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.VolumeConst VITHAU(k = 0.00014)
            "unstressed volume of intrathoracic arteries"                                                             annotation(Placement(                transformation(origin={74,11},   extent={{-4,-3},
                    {4,3}},                                                                                                    rotation = 0)));
          replaceable
            Physiolibrary.Types.Constants.HydraulicElastanceToComplianceConst           EITHA(k(displayUnit = "mmHg/ml") = 190651014.00345) annotation(Placement(                transformation(origin={78,23},     extent={{-4,-3},
                    {4,3}},                                                                                                    rotation = 0)));
          Physiolibrary.Hydraulic.Components.Conductor ArterioralConductance(
              useConductanceInput=true) annotation (Placement(transformation(
                ...
                rotation=0,
                origin={27,-20})));
          Physiolibrary.Hydraulic.Components.Conductor SmallVenuleConductance(useConductanceInput = true) annotation(Placement(transformation(extent={{7,-6},{
                    -7,6}},                                                                                                    rotation = 0, origin={-9,-20})));
          Physiolibrary.Hydraulic.Components.ElasticVessel PeripheralVessels(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 0.000283) annotation(Placement(transformation(extent={{2,-26},
                    {14,-14}})));
          Physiolibrary.Types.Constants.VolumeConst UVST(k = 0.000185) annotation(Placement(                transformation(origin={-1,-9},     extent={{-3,-3},
                    {3,3}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst             RTA(k(displayUnit = "(mmHg.s)/ml") = 26664477.483) annotation(Placement(                transformation(origin={-13,-11},   extent={{-3,-3},
                    {3,3}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst             RSP(k(displayUnit = "(mmHg.s)/ml") = 106657909.932) annotation(Placement(                transformation(origin={21,-9},      extent={{-3,-3},
                    {3,3}},                                                                                                    rotation=0)));
          Physiolibrary.Types.Constants.HydraulicElastanceToComplianceConst EST(k = 34930465.50273) annotation(Placement(                transformation(origin={-2.5,-1}, extent={{-3.5,-3},
                    {3.5,3}},                                                                                                    rotation=0)));
          Physiolibrary.Hydraulic.Components.Conductor VeinsConductance(
              useConductanceInput=true) annotation (Placement(transformation(
                ...
                rotation=0,
                origin={-37,0})));
          Physiolibrary.Hydraulic.Components.Conductor CentralVenousResistance(useConductanceInput = true) annotation(Placement(transformation(extent={{6,-6},{
                    -6,6}},
                rotation=0,
                origin={-76,0})));
          Physiolibrary.Hydraulic.Components.ElasticVessel IntraThoracicVeins(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 0.00148) annotation(Placement(transformation(extent={{-6,-6},
                    {6,6}},
                rotation=0,
                origin={-58,0})));
          Physiolibrary.Hydraulic.Components.ElasticVessel ExtrathoracicVeins(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 0.00153) annotation(Placement(transformation(extent={{-6,-6},
                    {6,6}},
                rotation=0,
                origin={-22,0})));
          Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst             RETHV(k(displayUnit = "(Pa.s)/m3") = 11999014.86735) annotation(Placement(                transformation(origin={-44,11},   extent={{-4,-3},
                    {4,3}},                                                                                                    rotation=0)));
          Physiolibrary.Types.Constants.VolumeConst VETHVU(k(displayUnit = "m3") = 0.001) annotation(Placement(                transformation(origin={-32,11},   extent={{-4,-3},
                    {4,3}},                                                                                                    rotation=0)));
          Physiolibrary.Types.Constants.HydraulicElastanceToComplianceConst EETHV(k(displayUnit = "Pa/m3") = 2253148.3473135) annotation(Placement(                transformation(origin={-28,19},   extent={{-4,-3},
                    {4,3}},                                                                                                    rotation=0)));
          Physiolibrary.Types.Constants.HydraulicElastanceToComplianceConst             EITHV(k(displayUnit = "Pa/m3") = 2426467.450953) annotation(Placement(                transformation(origin={-64,23},    extent={{-4,-3},
                    {4,3}},                                                                                                    rotation=0)));
          Physiolibrary.Types.Constants.VolumeConst             VITHVU(k(displayUnit = "m3") = 0.00119) annotation(Placement(                transformation(origin={-68,15},    extent={{-4,-3},
                    {4,3}},                                                                                                    rotation=0)));
          Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst             RRAIN(k(displayUnit = "(mmHg.s)/ml") = 399967.162245) annotation(Placement(                transformation(origin={-84,9},    extent={{-4,-3},
                    {4,3}},                                                                                                    rotation=0)));
          Physiolibrary.Types.Constants.PressureConst Pth(k=-533.28954966)   annotation(Placement(transformation(extent={{-3,-3},
                    {3,3}},                                                                                                    rotation = 0, origin={-57,33})));
          Physiolibrary.Types.Constants.PressureConst Pext(k=0)              annotation(Placement(transformation(extent={{-3,-3},
                    {3,3}},                                                                                                    rotation = 0, origin={-45,27})));
        equation
          connect(EITHA.y,IntraThoracicArteries. compliance) annotation(Line(points={{83,23},
                  {84,23},{84,2.8}},                                                                                    color={0,0,127},
              smooth=Smooth.None));
          connect(RETHA.y, ArteriesConductance.cond)
            annotation (Line(points={{52.75,13},{54,13},{54,1.6}},
                                                          color={0,0,127},
              smooth=Smooth.None));
          connect(inertia.q_out, ArteriesConductance.q_out) annotation (Line(
              ...
              thickness=1,
              smooth=Smooth.None));
          connect(ArteriesConductance.q_in, ExtrathoracicArteries.q_in) annotation (
             Line(
              points={{48,-2},{40,-2}},
              color={0,0,0},
              thickness=1,
              smooth=Smooth.None));
          connect(VETHAU.y, ExtrathoracicArteries.zeroPressureVolume) annotation (
              Line(
              points={{36.75,12.5},{36.75,2.8},{35.2,2.8}},
              color={0,0,127},
              smooth=Smooth.None));
          connect(RTA.y,SmallVenuleConductance. cond) annotation(Line(points={{-9.25,
                  -11},{-9,-11},{-9,-16.4}},                                                                          color={0,0,127},     smooth=Smooth.
                  None));
          connect(ArterioralConductance.q_out, PeripheralVessels.q_in) annotation (
              Line(
              points={{20,-20},{8,-20}},
              color={0,0,0},
              thickness=1,
              smooth=Smooth.None));
          connect(PeripheralVessels.q_in,SmallVenuleConductance. q_in) annotation(Line(points={{8,-20},
                  {-2,-20}},                                                                                                    color={0,0,0},     thickness=1,   smooth=Smooth.
                  None));
          ...
          connect(EST.y, PeripheralVessels.compliance) annotation (Line(
              ...
              color={0,0,127},
              smooth=Smooth.None));
          connect(RRAIN.y,CentralVenousResistance. cond) annotation(Line(points={{-79,9},
                  {-79,8},{-76,8},{-76,3.6}},                                                                       color={0,0,127},     smooth=Smooth.
                  None));
          connect(RETHV.y, VeinsConductance.cond) annotation (Line(
              points={{-39,11},{-39,3.6},{-37,3.6}},
              color={0,0,127},
              smooth=Smooth.None));
          connect(IntraThoracicVeins.q_in, VeinsConductance.q_out) annotation (Line(
              points={{-58,0},{-46,0}},
              color={0,0,0},
              thickness=1,
              smooth=Smooth.None));
          ...
          connect(ExtrathoracicArteries.compliance, EETHA.y) annotation (Line(
              ...
              color={0,0,127},
              smooth=Smooth.None));
          connect(PeripheralVessels.zeroPressureVolume, UVST.y) annotation (Line(
              points={{3.2,-15.2},{3.2,-14},{2.75,-14},{2.75,-9}},
              color={0,0,127},
              smooth=Smooth.None));
          connect(VeinsConductance.q_in, ExtrathoracicVeins.q_in) annotation (Line(
              points={{-28,0},{-22,0}},
              color={0,0,0},
              thickness=1,
              smooth=Smooth.None));
          ...
          connect(Pth.y, IntraThoracicVeins.externalPressure) annotation (Line(
              ...
              color={0,0,127},
              smooth=Smooth.None));
          connect(IntraThoracicArteries.externalPressure, Pth.y) annotation (Line(
          ...
          connect(PeripheralVessels.externalPressure, Pext.y) annotation (Line(
              ...
              color={0,0,127},
              smooth=Smooth.None));
          connect(ExtrathoracicArteries.externalPressure, Pext.y) annotation (Line(
        ...
        partial model SideOfHeart
          Physiolibrary.Hydraulic.Interfaces.HydraulicPort_a inflow annotation(Placement(transformation(extent = {{-106, -10}, {-86, 10}}), iconTransformation(extent={{-10,-12},
                    {10,8}})));
          Physiolibrary.Hydraulic.Interfaces.HydraulicPort_b outflow annotation(Placement(transformation(extent = {{84, -10}, {104, 10}}), iconTransformation(extent={{-10,70},
                    {10,90}})));
          ...
          replaceable VentricularElastance ventricularElastance(EMIN=
          ...
          Physiolibrary.Types.Constants.VolumeConst VxAU(k = 3e-005) annotation(Placement(                transformation(origin={-64,-15},    extent={{-8,-5},
                    {8,5}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicConductanceConst CxVBackflow(k = 0) annotation(Placement(                transformation(origin={79,-86},    extent={{-7,-6},
                    {7,6}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst             RxVOutflow(k(displayUnit = "(mmHg.s)/ml") = 1066579.09932)
            "resistance of pulmonic valve"                                                                                                     annotation(Placement(                transformation(origin={55,-77},    extent={{-7,-5},
                    {7,5}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.VolumeConst VxVU(k = 6e-005) annotation(Placement(                transformation(origin={21,-13},   extent={{-7,-5},
                    {7,5}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicConductanceConst CxABackflow(k = 0)
            "conductance of tricupsid valve backflow"                                                                          annotation(Placement(                transformation(origin={6.5,-81},  extent={{-6.5,-7},
                    {6.5,7}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.Constants.HydraulicResistanceToConductanceConst             RxAOutflow(k(displayUnit = "(mmHg.s)/ml") = 399967.162245)
            "resistance of tricupsid valve"                                                                                                     annotation(Placement(                transformation(origin={-21,
                    -77.5},                                                                                                    extent={{-7,-6.5},
                    {7,6.5}},                                                                                                    rotation = 0)));
          Physiolibrary.Types.RealIO.FrequencyInput HR annotation (Placement(
                ...
                origin={0,118})));
        equation
          connect(RxAOutflow.y, atrioVentricleValve.Gon) annotation(Line(points={{-12.25,
                  -77.5},{-0.8,-77.5},{-0.8,-68.5},{-0.8,-54}},                                                                              color={0,0,127},
              smooth=Smooth.None));
          connect(CxABackflow.y, atrioVentricleValve.Goff) annotation(Line(points={{14.625,
                  -81},{14.8,-81},{14.8,-69.5},{14.8,-54}},                                                                                   color={0,0,127},
              smooth=Smooth.None));
          connect(VxVU.y, ventricle.zeroPressureVolume) annotation(Line(points={{29.75,
                  -13},{29.75,-31},{31,-31}},                                                                                color={0,0,127},     smooth=Smooth.
                  None));
          connect(VxAU.y, atrium.zeroPressureVolume) annotation(Line(points={{-54,-15},
                  {-50,-15},{-50,-31.2},{-46.8,-31.2}},                                                                                 color={0,0,127},     smooth=Smooth.
                  None));
          connect(PTH, atrium.externalPressure) annotation(Line(points={{-18,2},{-18,-31.2},
                  {-21.2,-31.2}},                                                                                            color={0,0,127},     smooth=Smooth.
                  None));
          connect(PTH, ventricle.externalPressure) annotation(Line(points={{-18,2},{55,2},
                  {55,-31}},                                                                                color={0,0,127},     smooth=Smooth.None));
          connect(inflow, atrium.q_in) annotation(Line(points={{-96,0},{-86,0},{-86,-48},
                  {-34,-48},{-34,-44}},                                                                                   color={0,0,0},     thickness=1,   smooth=Smooth.
                  None));
          connect(atrium.q_in, atrioVentricleValve.q_in) annotation(Line(points = {{-34, -44}, {-20, -44}, {-20, -42}, {-6, -42}}, color={0,0,0},     thickness=1,   smooth=Smooth.
                  None));
          connect(ventricle.q_in, atrioVentricleValve.q_out) annotation(Line(points = {{43, -43}, {31.5, -43}, {31.5, -42}, {20, -42}}, color={0,0,0},     thickness=1,   smooth=Smooth.
                  None));
          connect(ventricle.q_in, ventricleArteryValve.q_in) annotation(Line(points = {{43, -43}, {53.5, -43}, {53.5, -42}, {64, -42}}, color={0,0,0},     thickness=1,   smooth=Smooth.
                  None));
          connect(ventricleArteryValve.q_out, outflow) annotation(Line(points={{88,-42},
                  {92,-42},{92,-32},{94,-32},{94,0}},                                                                                  color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
          connect(RxVOutflow.y, ventricleArteryValve.Gon) annotation(Line(points={{63.75,
                  -77},{63.75,-54},{68.8,-54}},                                                                                    color={0,0,127},     smooth=Smooth.
                  None));
          connect(CxVBackflow.y, ventricleArteryValve.Goff) annotation(Line(points={{87.75,
                  -86},{90,-86},{90,-54},{83.2,-54}},                                                                                color = {0, 0, 127}, smooth = Smooth.None));
          connect(atrialElastance.Ct, atrium.compliance) annotation (Line(
              points={{-34.39,19.84},{-34,19.84},{-34,-31.2}},
              color={0,0,127},
              smooth=Smooth.None));
          connect(ventricularElastance.Ct, ventricle.compliance) annotation (Line(
      ...
      model HemodynamicsMeurs
        extends Cardiovascular.System(redeclare Parts.PulmonaryCirculation pulmonaryCirculation,
          redeclare Parts.SystemicCirculation systemicCirculation,                                                                                        redeclare
            Parts.Heart heart);
      ...
      model HemodynamicsMeursVolume
        extends Cardiovascular.Control.SystemVolume(
                                                   redeclare
            Parts.PulmonaryCirculation pulmonaryCirculation,                                                  redeclare
            Parts.Heart heart,
      ...
      equation
        volume = pulmonaryCirculation.PulmonaryArteries.volume +
                 ...
                 systemicCirculation.IntraThoracicArteries.volume +
                 systemicCirculation.ExtrathoracicArteries.volume +
                 systemicCirculation.PeripheralVessels.volume +
                 systemicCirculation.ExtrathoracicVeins.volume +
      ...
      model HemodynamicsMeurs_flat
        ...
        Physiolibrary.Hydraulic.Components.ElasticVessel PulmonaryArteries(
          ...
          ExternalPressure=-533.28954966)                                                                                                     annotation(Placement(transformation(extent={{-94,84},
                  {-68,110}})));
        Physiolibrary.Hydraulic.Components.Conductor PulmonaryArteriesResistance(
            ...
            6.818059724437e-08)                                                                              annotation(Placement(transformation(extent={{-56,85},
                  {-22,111}})));
        Physiolibrary.Hydraulic.Components.ElasticVessel PulmonaryVeins(
          useV0Input=false,
          useExternalPressureInput=false,
          ...
          ExternalPressure=-533.28954966)                                                                                                     annotation(Placement(transformation(extent={{-10,86},
                  {14,110}})));
        Physiolibrary.Hydraulic.Components.Conductor PulmonaryVeinResistance(
            useConductanceInput=false, Conductance(displayUnit="ml/(mmHg.s)")=
            2.4999552322936e-06)                                                                         annotation(Placement(transformation(extent={{26,86},
                  {56,110}})));
        ...
        Physiolibrary.Hydraulic.Components.IdealValve ventricleArteryValve(
          ...
          useLimitationInputs=false)                                                                   annotation(Placement(transformation(extent={{184,76},
                  {208,52}})));
        ...
        Physiolibrary.Hydraulic.Components.IdealValve atrioVentricleValve(
          ...
          _Goff(displayUnit="ml/(mmHg.s)") = 0)                                                       annotation(Placement(visible = true, transformation(origin={127,64},   extent = {{-13, 12}, {13, -12}}, rotation = 0)));
        Physiolibrary.Hydraulic.Components.ElasticVessel IntraThoracicArteries(
          ...
          ExternalPressure=-533.28954966)                                                                                                     annotation(Placement(transformation(extent={{168,6},
                  {190,28}})));
        Physiolibrary.Hydraulic.Components.ElasticVessel ExtrathoracicArteries(                                                                               volume_start(displayUnit = "ml") = 0.000526,
          useV0Input=false,
          useExternalPressureInput=false,
          ZeroPressureVolume=0.00037,
          useComplianceInput=false,
          Compliance=1.3493607749463e-08)                                                                                                     annotation(Placement(transformation(extent={{58,6},{
                  84,32}})));
        ...
        Physiolibrary.Hydraulic.Components.Conductor SystemicArterioralConductance(
            useConductanceInput=false, Conductance(displayUnit="ml/(mmHg.s)")=
            9.3757696980707e-09)                                                                               annotation(Placement(transformation(extent = {{11, -9}, {-11, 9}}, rotation = 0, origin={21,9})));
        Physiolibrary.Hydraulic.Components.Conductor SmallVenuleConductance(
            useConductanceInput=false, Conductance(displayUnit="ml/(mmHg.s)")=
            3.7503078792283e-08)                                                                        annotation(Placement(transformation(extent = {{14, -9}, {-14, 9}}, rotation = 0, origin={-60,11})));
        Physiolibrary.Hydraulic.Components.ElasticVessel PeripheralVessels(
          ...
          Compliance=2.8652352197304e-08)                                                                                                     annotation(Placement(transformation(extent={{-26,-2},
                  {-6,18}})));
        Physiolibrary.Hydraulic.Components.Conductor VeinsResistance(
            useConductanceInput=false, Conductance(displayUnit="ml/(mmHg.s)")=
            8.3256834918868e-08)                                                                 annotation(Placement(transformation(extent={{-120,6},
                  {-148,28}})));
        Physiolibrary.Hydraulic.Components.Conductor CentralVenousResistance(
            useConductanceInput=false, Conductance(displayUnit="ml/(mmHg.s)")=
            2.4999552322936e-06)                                                                         annotation(Placement(transformation(extent={{-208,8},
                  {-232,28}})));
        Physiolibrary.Hydraulic.Components.ElasticVessel IntraThoracicVeins(
          ...
          ExternalPressure=-533.28954966)                                                                                                     annotation(Placement(transformation(extent={{-192,4},
                  {-164,32}})));
        Physiolibrary.Hydraulic.Components.ElasticVessel ExtrathoracicVeins(
          ...
          useComplianceInput=false,
          Compliance=4.4403645290063e-07)                                                                                                     annotation(Placement(transformation(extent={{-116,4},
                  {-90,30}})));
        ...
        Physiolibrary.Hydraulic.Components.IdealValve ventricleArteryValve1(
          _Gon(displayUnit="ml/(mmHg.s)") = 2.4999552322936e-06,
          _Goff(displayUnit="ml/(mmHg.s)") = 0,
          useLimitationInputs=false)                                                                   annotation(Placement(transformation(extent={{-132,70},
                  {-108,46}})));
        ...
        Physiolibrary.Hydraulic.Components.IdealValve atrioVentricleValve1(
          ...
          _Goff=0,
          useLimitationInputs=false)                                                                  annotation(Placement(visible = true, transformation(origin={-189,58},  extent = {{-13, 12}, {13, -12}}, rotation = 0)));
        replaceable Physiolibrary.Types.Constants.FrequencyConst HeartRate(k(displayUnit = "1/min") = 1.2) annotation(Placement(visible = true, transformation(origin={-243,
                  128.5},                                                                                                    extent={{-11,
                  -6.5},{11,6.5}},                                                                                                    rotation = 0)));
      equation
        connect(PulmonaryArteries.q_in,PulmonaryArteriesResistance. q_in) annotation(Line(points={{-81,97},
                {-68.5,97},{-68.5,98},{-56,98}},                                                                                                   color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(PulmonaryArteriesResistance.q_out,PulmonaryVeins. q_in) annotation(Line(points={{-22,98},
                {2,98}},                                                                                             color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(PulmonaryVeins.q_in,PulmonaryVeinResistance. q_in) annotation(Line(points={{2,98},{
                26,98}},                                                                                        color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        ...
        connect(LeftVentricle.compliance, ventricularElastance.Ct) annotation (
            ...
            color={0,0,127},
            smooth=Smooth.None));
        connect(PulmonaryVeinResistance.q_out, LeftAtrium.q_in) annotation (Line(
        ...
        connect(ArteryResistance.q_out, inertia.q_out) annotation (Line(
            ...
            thickness=1,
            smooth=Smooth.None));
        connect(inertia.q_in,IntraThoracicArteries. q_in) annotation(Line(points={{146,18},
                {162,18},{162,17},{179,17}},                                                                             color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(IntraThoracicArteries.q_in, ventricleArteryValve.q_out) annotation (
            Line(
            points={{179,17},{216,17},{216,64},{208,64}},
            color={0,0,0},
            thickness=1,
            smooth=Smooth.None));
        connect(SystemicArterioralConductance.q_out,PeripheralVessels. q_in) annotation(Line(points={{10,9},{
                -2,9},{-2,8},{-16,8}},                                                                                                    color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(PeripheralVessels.q_in,SmallVenuleConductance. q_in) annotation(Line(points={{-16,8},
                {-32,8},{-32,11},{-46,11}},                                                                                              color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(SystemicArterioralConductance.q_in, ExtrathoracicArteries.q_in)
          annotation (Line(
            ...
            thickness=1,
            smooth=Smooth.None));
        connect(CentralVenousResistance.q_in,IntraThoracicVeins. q_in) annotation(Line(points={{-208,18},
                {-178,18}},                                                                                               color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(IntraThoracicVeins.q_in,VeinsResistance. q_out) annotation(Line(points={{-178,18},
                {-164,18},{-164,17},{-148,17}},                                                                                         color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(VeinsResistance.q_in,ExtrathoracicVeins. q_in) annotation(Line(points={{-120,17},
                {-103,17}},                                                                                     color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
        connect(ExtrathoracicVeins.q_in, SmallVenuleConductance.q_out) annotation (
            Line(
        ...
        connect(RightAtrium.q_in, atrioVentricleValve1.q_in) annotation (Line(
            ...
            thickness=1,
            smooth=Smooth.None));
        connect(rightVentricle.q_in, atrioVentricleValve1.q_out) annotation (Line(
            points={{-153,57},{-164.5,57},{-164.5,58},{-176,58}},
            color={0,0,0},
            thickness=1,
            smooth=Smooth.None));
        connect(rightVentricle.q_in, ventricleArteryValve1.q_in) annotation (Line(
            points={{-153,57},{-142.5,57},{-142.5,58},{-132,58}},
            color={0,0,0},
            thickness=1,
            smooth=Smooth.None));
        connect(CentralVenousResistance.q_out, RightAtrium.q_in) annotation (Line(
        ...
        connect(RightAtrium.compliance, atrialElastance1.Ct) annotation (Line(
            ...
            color={0,0,127},
            smooth=Smooth.None));
        connect(ventricleArteryValve1.q_out, PulmonaryArteries.q_in) annotation (Line(
            points={{-108,58},{-92,58},{-92,97},{-81,97}},
            color={0,0,0},
            thickness=1,
            smooth=Smooth.None));
        connect(rightVentricle.compliance, ventricularElastance1.Ct) annotation (
            Line(
        ...
        annotation (Diagram(coordinateSystem(extent={{-280,-140},{280,180}},
                preserveAspectRatio=false), graphics), Icon(coordinateSystem(extent={{
                  -280,-140},{280,180}}, preserveAspectRatio=false), graphics));
      end HemodynamicsMeurs_flat;
    end Meurs;

    package Experiment
      model MeursVariableVolume
        extends Cardiovascular.Control.SystemVolumeControl(redeclare
            Cardiovascular.Control.VariableVolumeControl volumeControl(
              volumeControl(enabled=true)),
            redeclare Cardiovascular.Model.Meurs.HemodynamicsMeursVolume systemVolume);
      ...
      model BurkhoffVariableVolume
        extends Cardiovascular.Control.SystemVolumeControl(redeclare
            Cardiovascular.Control.VariableVolumeControl volumeControl(
              volumeControl(enabled=true)),
            redeclare Burkhoff.HemodynamicsBurkhoffVolumeControl         systemVolume);
    ...
    package Burkhoff
      ...
      equation
        ...
        connect(RV.StressedVolume, ventricularElastance.Vs) annotation (Line(
            points={{21.6,-29.8},{21.6,-28},{6,-28},{6,-22},{5.7,-22},{5.7,
                -14.9}},
            color={0,0,127},
            smooth=Smooth.None));
        ...
        model SideOfHeart "abstract model for heart side"
          ...
          Physiolibrary.Hydraulic.Interfaces.HydraulicPort_b outflow annotation (
              Placement(transformation(extent={{90,-10},{110,10}}), iconTransformation(
                  extent={{-18,54},{2,74}})));
          Physiolibrary.Types.RealIO.PressureInput PTH "Intrathoracic Pressure"
                                                                                annotation(Placement(transformation(extent = {{-10,-10},{10,10}}, rotation = 270, origin = {-56,50}), iconTransformation(extent={{-16,-16},
    ...
    model Windkessel_2element "Two-element Windkessel model"
      ...
      Physiolibrary.Hydraulic.Sources.UnlimitedVolume veins annotation (
          Placement(transformation(
            ...
            rotation=0,
            origin={-40,20})));
      pulses pulses1(QP(displayUnit="m3/s") = 0.000424,
           HR=1.2)
...
<li>Westerhof, N., Lankhaar, J.-W., &AMP; Westerhof, B. E. (2009). The arterial Windkessel. <i>Medical &AMP; Biological Engineering &AMP; Computing</i>, <i>47</i>(2), 131&ndash;41. doi:10.1007/s11517-008-0359-2</li>
  ...
  package Hydraulic
    ...
    package Components
      ...
      equation
        ...
        annotation(Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
              ...
              Ellipse(
                ...
                fillPattern=FillPattern.Solid,
                extent={{-70,-70},{70,70}}),                                                                            Text(extent = {{-52, 11}, {52, -11}}, lineColor=
                    {0,0,0},                                                                                                    fillColor=
                    {85,170,255},
                  fillPattern=FillPattern.Solid,                                                                                                    origin={
                    -79,-72},                                                                                                    rotation = 90,
                textString="Ps"),                                                                                                    Text(extent = {{-53, 10}, {53, -10}}, lineColor = {0, 0, 0}, fillColor = {85, 170, 255},
                  fillPattern =                                                                                                   FillPattern.Solid, origin={
                    -58,-71},                                                                                                    rotation = 90, textString = "Pd"), Text(extent = {{-55, 12}, {55, -12}}, lineColor = {0, 0, 0}, fillColor = {85, 170, 255},
                  fillPattern =                                                                                                   FillPattern.Solid, origin={
                    -36,-53},                                                                                                    rotation = 90, textString = "Pmean"),
              Polygon(
              ...
              Line(points={{0,-40},{0,-70}})}),                                                           Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics));
      ...
      equation
        ...
        der(SumPressure) = q_in.pressure;
        annotation(Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-100,-100},
                  {100,100}}),                                                                              graphics={  Text(extent = {{-32, 46}, {26, 32}}, lineColor = {0, 128, 0}, fillColor = {85, 170, 255},
        ...
        annotation(Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-100,-100},
              ...
              Text(
                ...
                textString="HR"),                                                                                                    Text(extent = {{-55, 12}, {55, -12}}, lineColor=
                    {0,0,0},                                                                                                    fillColor=
                    {85,170,255},
                  fillPattern=FillPattern.Solid,                                                                                                    origin={54,
                    -73},                                                                                                  rotation = 90,
                textString="CO"),                                                                                                    Text(extent = {{-55, 12}, {55, -12}}, lineColor=
                    {0,0,0},                                                                                                    fillColor=
                    {85,170,255},
                  fillPattern=FillPattern.Solid,                                                                                                    origin={32,
                    -73},                                                                                                  rotation = 90,
                textString="SV")}),                                                                                                    Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
                  -100},{100,100}}),                                                                                                    graphics));
  ...
  <p>Even it is not recommended, you can use this block, but do not forget to make reciprocal value (in example using Physiolibrary.Blocks.Math.Reciprocal) before connecting to library components!</p>
      ...
      block HydraulicComplianceControl
        ...
        Physiolibrary.Types.RealIO.HydraulicComplianceInput c annotation(Placement(transformation(extent = {{-40, -20}, {0, 20}}), iconTransformation(extent = {{-40, -20}, {0, 20}})));
      ...
      block HydraulicConductanceControl
        ...
        Physiolibrary.Types.RealIO.HydraulicConductanceOutput y
          "HydraulicCompliance constant"                                                       annotation(Placement(transformation(extent = {{40, -10}, {60, 10}}), iconTransformation(extent = {{40, -10}, {60, 10}})));
        Physiolibrary.Types.RealIO.HydraulicConductanceInput c annotation(Placement(transformation(extent = {{-40, -20}, {0, 20}}), iconTransformation(extent = {{-40, -20}, {0, 20}})));
  ...
  model System
    import Cardiovascular;
    replaceable Cardiovascular.Heart heart annotation(Placement(transformation(extent = {{-8, -8}, {6, 8}})));
    replaceable Cardiovascular.SystemicCirculation systemicCirculation annotation(Placement(transformation(extent = {{-12, -36}, {8, -16}})));
    replaceable Cardiovascular.PulmonaryCirculation pulmonaryCirculation annotation(Placement(transformation(extent = {{-12, 12}, {8, 32}})));
  equation
    connect(systemicCirculation.q_in, heart.leftHeartOutflow) annotation(Line(points={{8,-26},
            {10,-26},{10,-1.92},{6,-1.92}},                                                                                                    color = {190, 0, 0}, thickness = 1, smooth = Smooth.None));
    connect(heart.leftHeartInflow, pulmonaryCirculation.q_out) annotation(Line(points={{6,4.16},
            {10,4.16},{10,21.4},{7.8,21.4}},                                                                                                  color = {190, 0, 0}, thickness = 1, smooth = Smooth.None));
    connect(systemicCirculation.q_out, heart.rightHeartInflow) annotation(Line(points={{-12,-26},
            {-14,-26},{-14,-2.08},{-8,-2.08}},                                                                                                    color = {190, 0, 0}, thickness = 1, smooth = Smooth.None));
    connect(heart.rightHeartOutflow, pulmonaryCirculation.q_in) annotation(Line(points={{-8,4.16},
            {-14,4.16},{-14,21.8},{-11.8,21.8}},                                                                                                    color = {190, 0, 0}, thickness = 1, smooth = Smooth.None));
    annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-20, -40}, {20, 40}}), graphics), Icon(coordinateSystem(extent = {{-20, -40}, {20, 40}}, preserveAspectRatio = false), graphics={  Bitmap(extent = {{-30, 38}, {30, -36}},
  ...
  package Control
    model BloodTransfusionHemorrhage
      ...
      Physiolibrary.Types.RealIO.VolumeFlowRateInput volumeflowrate annotation(Placement(transformation(extent = {{-92, -76}, {-52, -36}}), iconTransformation(extent = {{-94, 40}, {-54, 80}})));
    equation
    ...
    model SystemVolume
      ...
      Physiolibrary.Hydraulic.Interfaces.HydraulicPort_a catheter annotation(Placement(transformation(extent = {{-26, -8}, {-10, 8}}), iconTransformation(extent={{-50,-8},
                {-32,10}})));
    equation
      ...
      annotation(Icon(coordinateSystem(extent={{-40,-40},{20,40}},      preserveAspectRatio=false,   initialScale = 0.1, grid = {2, 2}), graphics={  Line(points={{
                  -32,2},{-14,2}},                                                                                                    color = {190, 0, 0}, thickness = 1)}), Diagram(coordinateSystem(extent={{-40,-40},
                {20,40}},                                                                                                    preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics={  Text(origin = {1.362, 6.77779}, lineColor = {190, 0, 0},
  ...
  +systemic.volume",   fontSize = 5, fontName = "Courier New",
    ...
    model SimpleVolumeControl
      extends Cardiovascular.Control.VolumeControl;
      BloodTransfusionHemorrhage         bloodTransfusionHemorrhage annotation(Placement(transformation(extent={{66,-2},
                {92,32}})));
      DesiredFlowrate volumeControl(flowtime(displayUnit="s"), enabled=false)
        annotation (Placement(transformation(extent={{40,-10},{60,10}})));
      Physiolibrary.Types.Constants.VolumeConst desiredVolume(k=0.005)   annotation(Placement(transformation(extent={{28,14},
                {40,20}})));
    equation
      connect(desiredVolume.y,volumeControl. desiredVolume) annotation(Line(points={{41.5,17},
              {43.2,17},{43.2,7.2}},                                                                                             color = {0, 0, 127}, smooth = Smooth.None));
      ...
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{
            ...
            graphics={                                                                                                    Rectangle(extent={{
                  -28,2},{-24,-32}},                                                                                                    lineColor = {0, 0, 0},
                lineThickness =                                                                                                   1,
                fillPattern =                                                                                                   FillPattern.Sphere, fillColor = {190, 0, 0}), Rectangle(extent={{
                  26,4},{30,-32}},                                                                                                    lineColor = {0, 0, 0},
                lineThickness =                                                                                                   1,
                fillPattern =                                                                                                   FillPattern.Sphere, fillColor = {190, 0, 0}), Polygon(points={{2,
                  2},{2,-6},{4,-8},{8,-14},{6,-16},{8,-20},{10,-22},{12,-24},{
                  10,-26},{8,-30},{10,-32},{14,-34},{16,-36},{18,-42},{20,-44},
                  {24,-48},{30,-50},{36,-54},{44,-58},{50,-60},{56,-62},{60,-62},
                  {76,-64},{80,-50},{92,-22},{100,-8},{100,12},{70,-60},{60,-58},
                  {58,-58},{52,-54},{42,-52},{36,-48},{32,-46},{26,-44},{22,-38},
                  {20,-36},{18,-32},{14,-28},{18,-22},{12,-18},{12,-14},{14,-12},
                  {8,-6},{6,-2},{6,2},{2,2}},                                                                                                    lineColor=
                  {127,0,0},
                lineThickness=1,
                fillPattern=FillPattern.Sphere,                                                                                                    smooth=
                  Smooth.Bezier,                                                                                                    fillColor=
                  {190,0,0}),                                                                                                    Rectangle(extent={{
                  -32,92},{30,86}},                                                                                                    lineColor = {0, 0, 0},
                fillPattern =                                                                                                   FillPattern.Solid, fillColor = {170, 255, 255}), Rectangle(extent={{
                  -32,86},{30,62}},                                                                                                    lineColor = {0, 0, 0}, fillColor = {170, 255, 255},
                fillPattern =                                                                                                   FillPattern.Sphere, radius = 2,
                lineThickness =                                                                                                   1),
                                                                                                    Rectangle(extent={{
                  -32,66},{30,0}},                                                                                                    lineColor = {0, 0, 0},
                lineThickness =                                                                                                   1,
                fillPattern =                                                                                                   FillPattern.Sphere, fillColor = {190, 0, 0}, radius = 4),
            Line(
              points={{-24,80},{-24,68}},
              color={127,0,0},
              thickness=1,
    ...
    equation
      ...
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{
            ...
            graphics={                                                                                                    Bitmap(extent={{
                  -10,36},{50,-38}},
                imageSource =                                                                                                   "" + "" + "" + "" + "" + "" + "" + "", fileName = "modelica://Cardiovascular/Resources/Icons/cvsconcept.png"),
            Line(
              points={{-8,-4},{4,0}},
              color={127,0,0},
              thickness=1,
    ...
    model VariableVolumeControl
      ...
      DesiredFlowrate volumeControl(flowtime(displayUnit="s"), enabled=false)
        annotation (Placement(transformation(extent={{40,-10},{60,10}})));
    equation
      desiredVolume = 0.004 + div(time,60)*0.001; //each 60 seconds add 1 l
...
each 60 seconds add 1 l")}),     Icon(coordinateSystem(preserveAspectRatio=false,
            ...
            Rectangle(
              ...
              pattern=LinePattern.None),                                                                                                    Rectangle(extent={{
                ...
                lineThickness =                                                                                                   1,
                fillPattern =                                                                                                   FillPattern.Sphere, fillColor = {190, 0, 0}), Polygon(points={{2,
                  2},{2,-6},{4,-8},{8,-14},{6,-16},{8,-20},{10,-22},{12,-24},{10,-26},
                  {8,-30},{10,-32},{14,-34},{16,-36},{18,-42},{20,-44},{24,-48},{30,
                  -50},{36,-54},{44,-58},{50,-60},{56,-62},{60,-62},{76,-64},{80,-50},
                  {92,-22},{100,-8},{100,12},{70,-60},{60,-58},{58,-58},{52,-54},{42,
                  -52},{36,-48},{32,-46},{26,-44},{22,-38},{20,-36},{18,-32},{14,-28},
                  {18,-22},{12,-18},{12,-14},{14,-12},{8,-6},{6,-2},{6,2},{2,2}},                                                                                                    lineColor=
                  {127,0,0},
                lineThickness=1,
                fillPattern=FillPattern.Sphere,                                                                                                    smooth=
                  Smooth.Bezier,                                                                                                    fillColor=
            ...
            Line(
              ...
              smooth=Smooth.None),
            Line(
              points={{-98,2},{-88,2},{-86,20},{-70,20},{-68,40},{-52,40},{-50,
                  60},{-38,60},{-36,80}},
              color={127,0,0},
              thickness=1,
              smooth=Smooth.None),
  ...
  package Interfaces
    ...
    partial model SideOfHeart
      Physiolibrary.Hydraulic.Interfaces.HydraulicPort_a inflow annotation(Placement(transformation(extent={{-110,
                -10},{-90,10}}),                                                                                                    iconTransformation(extent={{-10,-12},
                {10,8}})));
      Physiolibrary.Hydraulic.Interfaces.HydraulicPort_b outflow annotation(Placement(transformation(extent={{90,-10},
                {110,10}}),                                                                                                    iconTransformation(extent={{-10,70},
                {10,90}})));
      ...
      Physiolibrary.Types.RealIO.FrequencyInput HR annotation (Placement(
            ...
            rotation=270,
            origin={0,118})));
      annotation(Icon(coordinateSystem(extent={{-100,-100},{100,100}},      preserveAspectRatio=false,   initialScale = 0.1, grid = {2, 2}), graphics={                                                 Text(lineColor = {0, 0, 255}, extent={{
                  -26,-62},{-8,-76}},                                                                                                   textString = "PTH"),
            Text(
              extent={{-14,98},{14,88}},
              lineColor={0,0,127},
              fillColor={255,255,170},
              fillPattern=FillPattern.Solid,
              textString="HR"),
            Ellipse(extent={{-20,90},{22,-20}}, lineColor={0,0,255})}),                                                              Diagram(coordinateSystem(extent={{-100,
                -100},{100,100}},                                                                                                    preserveAspectRatio=false,   initialScale = 0.1, grid = {2, 2}), graphics));
    end SideOfHeart;
    ...
    model HeartByParts
      ...
      Cardiovascular.Hydraulic.Components.BloodFlowMeasurement aortaFlowMeasurement annotation(Placement(visible = true, transformation(origin={40,12},   extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(leftHeart.outflow, aortaFlowMeasurement.q_in) annotation(Line(points={{-3.8,
              15.6},{22,12},{30,12}},                                                                            thickness = 1));
      connect(rightHeart.outflow, rightHeartOutflow) annotation(Line(points={{-25.8,
              11.12},{-68.5,11.12},{-68.5,20},{-100,20}},                                                                            thickness = 1));
      connect(rightHeartInflow, rightHeart.inflow) annotation(Line(points={{-100,
      ...
      connect(Pth.y, leftHeart.PTH) annotation(Line(points={{-38.5,-46},{-3.8,
              -46},{-3.8,-48}},                                                                          color = {0, 0, 127}, smooth = Smooth.None));
      connect(HeartRate.y, rightHeart.HR) annotation (Line(
    ...
    //  replaceable SideOfHeart sideOfHeart;
      Physiolibrary.Hydraulic.Interfaces.HydraulicPort_a inflow annotation(Placement(transformation(extent={{-110,
                -10},{-90,10}}),                                                                                                    iconTransformation(extent={{-14,10},
                {6,30}})));
      Physiolibrary.Hydraulic.Interfaces.HydraulicPort_b outflow annotation(Placement(transformation(extent={{90,-10},
                {110,10}}),                                                                                                    iconTransformation(extent={{-50,82},
                {-30,102}})));
    ...
    equation
      ...
      connect(outflow, sideOfHeart.outflow) annotation (Line(
          ...
          smooth=Smooth.None));
      annotation(Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
                -100},{100,100}}),                                                                        graphics={                                                                                    Text(lineColor = {0, 0, 255}, extent={{
                  -38,-86},{-20,-100}},                                                                                                 textString = "PTH"),
            Text(
              extent={{-86,100},{-58,90}},
              lineColor={0,0,127},
              fillColor={255,255,170},
    ...
    model RightHeart
      extends Physiolibrary.Icons.RightHeart;
      Physiolibrary.Hydraulic.Interfaces.HydraulicPort_a inflow annotation(Placement(transformation(extent={{-110,
                -10},{-90,10}}),                                                                                                    iconTransformation(extent={{-22,-6},
                {-2,14}})));
      Physiolibrary.Hydraulic.Interfaces.HydraulicPort_b outflow annotation(Placement(transformation(extent={{90,-10},
                {110,10}}),                                                                                                    iconTransformation(extent={{24,56},
                {44,76}})));
      Physiolibrary.Types.RealIO.PressureInput PTH "intrathoracic pressure" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}, rotation=180,   origin={100,54}),   iconTransformation(extent = {{-20, -20}, {20, 20}}, rotation = 90, origin={40,-120})));
      Physiolibrary.Types.RealIO.FrequencyInput HR annotation (Placement(
            transformation(extent={{-124,32},{-84,72}}), iconTransformation(
    ...
    equation
      ...
      connect(outflow, sideOfHeart.outflow) annotation (Line(
          ...
          smooth=Smooth.None));
      annotation(Icon(coordinateSystem(preserveAspectRatio=false,   extent={{-100,-100},
                {100,100}}),                                                                              graphics={                                                                                    Text(lineColor = {0, 0, 255}, extent={{
                  30,-86},{48,-100}},                                                                                                   textString = "PTH"),
            Text(
              extent={{26,94},{54,84}},
              lineColor={0,0,127},
              fillColor={255,255,170},
              fillPattern=FillPattern.Solid,
              textString="HR")}), Diagram(coordinateSystem(preserveAspectRatio=
  ...
  </html>"), uses(                 Physiolibrary(version="2.2.0"),
