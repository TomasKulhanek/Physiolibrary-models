...
package Cardiovascular
  ...
  equation
    ...
    annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-20, -40}, {20, 40}}), graphics), Icon(coordinateSystem(extent={{-20,-40},
              {20,40}},                                                                                                    preserveAspectRatio=false),   graphics={  Bitmap(extent={{-40,-40},{40,40}},fileName = "modelica://Cardiovascular/Resources/Icons/cvsconcept.png"), Text(
            extent={{-40,-40},{40,-48}},
            lineColor={0,0,255},
...
<p>It contains complementar models to the cardiovascular system in complex parametric model of human physiology Physiomodel.</p>
  ...
  package Controlled
    ...
    model Pulmonary "Abstract controlled pulmonary circulation submodel"
      ...
      Physiolibrary.Blocks.Types.BusConnector busConnector annotation (
          Placement(transformation(extent={{-100,14},{-60,54}}),
            iconTransformation(extent={{-100,12},{-60,52}})));
    end Pulmonary;

    partial model Heart "Abstract controlled heart circulation submodel"
      extends Cardiovascular.Interfaces.Heart;
      Physiolibrary.Blocks.Types.BusConnector busConnector annotation (
          Placement(transformation(extent={{-118,66},{-78,106}}),
            iconTransformation(extent={{-100,-90},{-60,-50}})));
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                -100},{100,100}}), graphics));
    end Heart;
    ...
    model Systemic "Abstract controlled systemic circulation submodel"
      ...
      Physiolibrary.Blocks.Types.BusConnector busConnector annotation (
          Placement(transformation(extent={{-100,14},{-60,54}}),
            iconTransformation(extent={{-96,-50},{-56,-10}})));
    ...
    partial model LongTermControl
      ...
      Physiolibrary.Blocks.Types.BusConnector busConnector annotation (
          Placement(transformation(extent={{0,-8},{40,32}}), iconTransformation(
              extent={{-38,4},{2,44}})));
    ...
    equation
      ...
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
            ...
            coordinateSystem(preserveAspectRatio=false, extent={{-100,
                -100},{100,100}}), graphics={Bitmap(extent={{-80,-80},{82,80}},
              fileName=
    ...
    partial model ShortTermControl
      ...
      Physiolibrary.Blocks.Types.BusConnector busConnector annotation (
          Placement(transformation(extent={{-28,14},{12,54}}),
            iconTransformation(extent={{60,70},{100,110}})));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent=
               {{-100,-100},{100,100}}), graphics={Bitmap(extent={{-80,-80},{80,80}},
    ...
    model ScenarioControl "Abstract submodel of possible scenarios"
      ...
      Physiolibrary.Blocks.Types.BusConnector busConnector annotation (
          Placement(transformation(extent={{60,70},{100,110}}),
            iconTransformation(extent={{60,70},{100,110}})));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                -100},{100,100}}),       graphics={
            Rectangle(
  ...
  package Model
    ...
    package Meurs
      ...
      model HemodynamicsMeurs_shallow
        ...
        replaceable Physiolibrary.Blocks.Types.Constants.FrequencyConst
          HeartRate(k(displayUnit="1/min") = 1.2) annotation (Placement(visible
              =true, transformation(
              origin={-243,128.5},
              extent={{-11,-6.5},{11,6.5}},
              rotation=0)));
        Physiolibrary.Blocks.Types.Constants.PressureConst
          IntraThoracicPressure(k=-533.28954966) annotation (Placement(
              transformation(
              extent={{-9,-6},{9,6}},
              rotation=0,
              origin={-123,118})));
...
<p>[11] W. van Meurs, Modeling and Simulation in Biomedical Engineering: Applications in Cardiorespiratory Physiology, McGraw-Hill Professional, 2011.</p>
      ...
      package Parts
        ...
        model Heart
          ...
          replaceable Physiolibrary.Blocks.Types.Constants.FrequencyConst
            HeartRate(k(displayUnit="1/min") = 1.2) annotation (Placement(
                visible=true, transformation(
                origin={59,92},
                extent={{-7,-6},{7,6}},
                rotation=180)));
        ...
        model AtrialElastance
          ...
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceOutput Ct
            "compliance" annotation (Placement(transformation(extent={{100,-10},
                    {120,10}}), iconTransformation(extent={{100,-20},{138,18}})));
          Physiolibrary.Blocks.Types.HydraulicElastance Et "elasticity";
          parameter Physiolibrary.Blocks.Types.HydraulicElastance EMIN
            "Diastolic elastance";
        parameter Boolean useEs_extInput = false
            "=true, if external elastance/compliance value is used"
            annotation(Evaluate=true, HideResult=true, choices(__Dymola_checkBox=true),Dialog(group="External inputs/outputs"));
          parameter Physiolibrary.Blocks.Types.HydraulicElastance EMAX
            "Maximum systolic elastance"
            annotation (Dialog(enable=not useEs_extInput));
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceInput Es_ext(
              start=1/Ees) = 1/es_int if                                                    useEs_extInput
            annotation (Placement(transformation(extent={{60,60},{100,100}}),
                ...
                origin={-80,80})));
        protected
          Physiolibrary.Blocks.Types.HydraulicElastance es_int;
        equation
        ...
        model VentricularElastance
          ...
          Physiolibrary.Blocks.Types.RealIO.TimeOutput HeartInterval
            "eapsed time" annotation (Placement(transformation(extent={{102,-42},
                    {122,-22}}), iconTransformation(extent={{100,-98},{138,-60}})));
          Physiolibrary.Blocks.Types.HydraulicElastance Et;
          parameter Physiolibrary.Blocks.Types.HydraulicElastance EMIN
            "Diastolic elastance ";
        ...
        parameter Boolean useEs_extInput = false
          ...
          parameter Physiolibrary.Blocks.Types.HydraulicElastance EMAX
            ...
            annotation (Dialog(enable=not useEs_extInput));
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceInput Es_ext(
              start=1/EMAX) = 1/es_int if                                                    useEs_extInput
            annotation (Placement(transformation(extent={{60,60},{100,100}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=0,
        ...
        model HeartIntervals
          discrete Physiolibrary.Blocks.Types.Time Tas;
          discrete Physiolibrary.Blocks.Types.Time T0;
          discrete Physiolibrary.Blocks.Types.Time Tvs;
          parameter Physiolibrary.Blocks.Types.Time Tav(displayUnit="s") = 0.01
            "atrioventricular delay";
          discrete Modelica.SIunits.Time HP(start = 0) "heart period";
          Boolean b(start = false);
          Physiolibrary.Blocks.Types.RealIO.FrequencyInput HR "heart rate"
            annotation (Placement(transformation(extent={{-12,68},{28,108}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=270,
                origin={0,80})));
...
<p>[11] W. van Meurs, Modeling and Simulation in Biomedical Engineering: Applications in Cardiorespiratory Physiology, McGraw-Hill Professional, 2011.</p>
    ...
    package Burkhoff
      ...
      Resistor Ras(Resistance=
        ...
        Physiolibrary.Blocks.Types.Constants.FrequencyConst heartRate(k=
              1.3333333333333)
        ...
        Modelica.Blocks.Math.Add add3 annotation (Placement(transformation(
              ...
              origin={109,11})));
        Physiolibrary.Blocks.Types.Constants.PressureConst
          IntraThoracicPressure(k=0) annotation (Placement(transformation(
              extent={{-4,-4},{4,4}},
              rotation=0,
              origin={50,-4})));
      equation
...
<p>[8] Harvi - interactive simulation-based digital textbook of cardiovascular physiology and hemodynamics. URL http://www.pvloops.com</p>
      ...
      package Parts
        ...
        model ElasticVesselWithSVandP
          ...
          Physiolibrary.Blocks.Types.RealIO.VolumeOutput StressedVolume
            annotation (Placement(transformation(
                extent={{-20,-20},{20,20}},
                rotation=270,
        ...
        partial model HeartElastance
          ...
          import Physiolibrary.Blocks.Types.*;
          ...
          RealIO.HydraulicComplianceOutput Ct annotation (Placement(
                ...
                origin={30,-86})));
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceInput Es_ext(
              start=1/Ees) = 1/mes if                                                      useEs_extInput
            annotation (Placement(transformation(extent={{64,56},{104,96}}),
                iconTransformation(
                extent={{-13,-13},{13,13}},
                rotation=180,
                origin={87,67})));
        ...
        model HeartIntervals
          discrete Physiolibrary.Blocks.Types.Time HP(start=0)
            "heart period - duration of cardiac cycle";
          Boolean b(start = false);
          Physiolibrary.Blocks.Types.RealIO.FrequencyInput HR annotation (
              Placement(
              transformation(
              ...
              iconTransformation(
                ...
                rotation=0),
              visible=true));
          Physiolibrary.Blocks.Types.Time Tasyst
            "time elapsed from the beginning of atrial systole";
          Physiolibrary.Blocks.Types.Time Tvsyst
            "time elapsed from the beginning of ventricular systole";
          parameter Physiolibrary.Blocks.Types.Time AVDelay(displayUnit="s") =
            0.160 "AV interval";
          Physiolibrary.Blocks.Types.Time T0 "start time of cardiac cycle";
          Physiolibrary.Blocks.Types.Time EDTV "Ventricular end Diastolic Time";
        equation
    ...
    package Smith2004
      ...
      Inertia Lmt(
          ...
          annotation (Placement(transformation(
              ...
              rotation=180,
              origin={70,-20})));
        Physiolibrary.Blocks.Types.Constants.FrequencyConst HR(k=1.2)
          annotation (Placement(transformation(extent={{-44,0},{-28,14}})));
        Physiolibrary.Blocks.Types.Constants.PressureConst
          IntraThoracicPressure(k=-533.28954966)
      ...
      equation
        ...
        annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-160,
                  -100},{160,100}}),      graphics={Rectangle(extent={{-158,62},{-82,
                    -34}}, lineColor={28,108,200}), Rectangle(extent={{-84,54},{92,
                    -46}}, lineColor={28,108,200})}),Icon(coordinateSystem(extent={{-160,
                  -100},{160,100}})),
          Documentation(info="<html>
...
<p>[13] CellML implementation at URL:  http://models.cellml.org/exposure/9d046663ba5cac5c8a61ac146183614b/smith_chase_nokes_shaw_wake_2004.cellml/view</p>
      ...
      package Parts
        ...
        ElasticWall elasticWall(volume(
          ...
          Physiolibrary.Blocks.Types.RealIO.VolumeOutput volume(start=2e-06)
            annotation (Placement(transformation(
                rotation=180,
                extent={{-10,-10},{10,10}},
          ...
          Physiolibrary.Blocks.Types.RealIO.FrequencyInput HR annotation (
              Placement(transformation(rotation=0, extent={{-94,10},{-74,30}}),
        ...
        ElasticVesselWithSVandP ventricle(
          ...
          Physiolibrary.Blocks.Types.RealIO.VolumeOutput stressedVolume
            annotation (Placement(transformation(
                ...
                origin={30,-10})));
          Physiolibrary.Blocks.Types.RealIO.FrequencyInput HR annotation (
              Placement(transformation(rotation=0, extent={{-56,6},{-36,26}}),
                iconTransformation(extent={{-40,20},{-20,40}})));
          Physiolibrary.Blocks.Types.RealIO.VolumeOutput volume annotation (
              Placement(transformation(
                extent={{-10,-10},{10,10}},
                rotation=180,
        ...
        //  Physiolibrary.Types.Pressure Plv,Plvf,Pperi,Prv,Prvf,Ppcd,Pth,Pspt;
          ...
          Physiolibrary.Hydraulic.Interfaces.HydraulicPort_a lvflow annotation (
             Placement(transformation(extent={{-46,-22},{-26,-2}}),
                iconTransformation(extent={{-10,-110},{10,-90}})));
          Physiolibrary.Blocks.Types.RealIO.FrequencyInput frequency
        ...
        Pericardium pericardium(
            ...
            P0=66.701190423724) annotation (Placement(transformation(
                ...
                rotation=180,
                origin={25,12})));
          Physiolibrary.Blocks.Types.RealIO.PressureInput Pth annotation (
              Placement(transformation(extent={{-6,24},{14,44}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=180,
                origin={80,8})));
...
*/
        ...
        model TimeVaryingElastance
          ...
          parameter Boolean useEs_extInput = false
            "=true, if external elastance/compliance value is used"
            annotation(Evaluate=true, HideResult=true, choices(__Dymola_checkBox=true),Dialog(group="External inputs/outputs"));
          parameter Physiolibrary.Blocks.Types.HydraulicElastance Es
            "elastance of systole"
            annotation (Dialog(enable=not useEs_extInput));
          parameter Physiolibrary.Blocks.Types.Pressure Pi0
            "peak isovolumic pressure";
          parameter HydraulicLambda lambda;
          Physiolibrary.Blocks.Types.Time tm
            "relative time from the beginning of cardiac cycle";
          discrete Physiolibrary.Blocks.Types.Time HP "heart period";
          discrete Physiolibrary.Blocks.Types.Time t0
            "time of beginning of the cardiac cycle";
          discrete Physiolibrary.Blocks.Types.Time ts "duration of systole";
          Real et;
          parameter Real A=1,B=80,CC=0.375;
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceOutput C
            annotation (Placement(transformation(extent={{-4,-102},{16,-82}}),
                iconTransformation(
                extent={{-14,-14},{14,14}},
                rotation=0,
                origin={66,14})));
          Physiolibrary.Blocks.Types.HydraulicElastance E;
          Physiolibrary.Blocks.Types.RealIO.PressureOutput Pi annotation (
              Placement(transformation(extent={{-72,-100},{-52,-80}}),
                ...
                origin={66,66})));
          Physiolibrary.Blocks.Types.RealIO.FrequencyInput HR "heart rate"
            annotation (Placement(transformation(extent={{76,58},{116,98}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=0,
                origin={-100,60})));
          Physiolibrary.Blocks.Types.RealIO.VolumeInput V annotation (Placement(
                transformation(extent={{82,54},{122,94}}), iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=180,
                origin={60,-40})));
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceInput Es_ext(
              start=1/Es) = 1/es_int if                                                    useEs_extInput
            annotation (Placement(transformation(extent={{60,60},{100,100}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=0,
  ...
  */
        ...
        model Pericardium
          parameter Physiolibrary.Blocks.Types.Volume V0;
          parameter Physiolibrary.Blocks.Types.Pressure P0;
          parameter HydraulicLambda lambda;
          Physiolibrary.Blocks.Types.RealIO.VolumeInput Vsept annotation (
              Placement(transformation(extent={{40,-36},{80,4}}),
                iconTransformation(
                extent={{-11,-11},{11,11}},
                rotation=0,
                origin={-29,1})));
          Physiolibrary.Blocks.Types.RealIO.PressureOutput pressure annotation
            (Placement(transformation(extent={{-40,-10},{-20,10}}),
                iconTransformation(
                extent={{-10,-10},{10,10}},
                rotation=0,
                origin={50,90})));
          Physiolibrary.Blocks.Types.RealIO.VolumeInput Vrvfw annotation (
              Placement(transformation(extent={{40,-36},{80,4}}),
                iconTransformation(
                extent={{-11,-11},{11,11}},
                rotation=0,
                origin={-29,29})));
          Physiolibrary.Blocks.Types.RealIO.VolumeInput Vlvfw annotation (
              Placement(transformation(extent={{40,-36},{80,4}}),
                iconTransformation(
                extent={{-11,-11},{11,11}},
                rotation=0,
                origin={-29,-31})));
          Physiolibrary.Blocks.Types.Volume Vperi;
          Physiolibrary.Blocks.Types.Pressure Pperi;
          Physiolibrary.Blocks.Types.RealIO.VolumeOutput Vrv annotation (
              Placement(transformation(extent={{40,20},{60,40}}),
                iconTransformation(extent={{40,20},{60,40}})));
          Physiolibrary.Blocks.Types.RealIO.VolumeOutput Vlv annotation (
              Placement(transformation(extent={{36,20},{56,40}}),
                iconTransformation(extent={{40,-40},{60,-20}})));
          Physiolibrary.Blocks.Types.RealIO.PressureInput Pth annotation (
              Placement(transformation(extent={{-50,60},{-10,100}}),
                iconTransformation(extent={{-40,78},{-18,100}})));
        equation
          Vperi = Vrvfw+Vlvfw;
          Vrv = Vrvfw+Vsept;
          Vlv= Vlvfw-Vsept;
        ...
        model Heart
          ...
          replaceable Physiolibrary.Blocks.Types.Constants.FrequencyConst HR(k=
                1.2)
          ...
          Physiolibrary.Blocks.Types.Constants.PressureConst Pth(k=-533.28954966)
        ...
        model ElasticWall
          ...
          Physiolibrary.Blocks.Types.RealIO.PressureInput prv annotation (
              Placement(transformation(extent={{-26,32},{14,72}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=270,
                origin={-38,6})));
          Physiolibrary.Blocks.Types.RealIO.PressureInput plv annotation (
              Placement(transformation(extent={{-26,-54},{14,-14}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=90,
                origin={-52,-50})));
          Physiolibrary.Blocks.Types.RealIO.PressureOutput pressure annotation
            (Placement(transformation(extent={{-2,-94},{18,-74}}),
                ...
                origin={110,-46})));
          Physiolibrary.Blocks.Types.RealIO.VolumeOutput volume annotation (
              Placement(transformation(extent={{-112,-66},{-92,-46}}),
                iconTransformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={-96,-56})));
          parameter Physiolibrary.Blocks.Types.Volume V0=0;
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceInput compliance
  ...
  pressure = (volume-V0) /compliance;")}), Diagram(coordinateSystem(preserveAspectRatio=
      ...
      package ControlledParts
        ...
        model HeartControl
          ...
          extends Controlled.Heart;
          extends Parts.Heart(
            redeclare Types.Constants.FrequencyControl HR,
            redeclare VIVolume
        ...
        model VIVolume
          ...
          Physiolibrary.Blocks.Types.BusConnector busConnector annotation (
              Placement(transformation(extent={{-72,32},{-32,72}}),
                iconTransformation(extent={{-72,32},{-32,72}})));
        equation
        ...
        model VentricleControlled
          ...
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceInput
    ...
    package Fernandez
      ...
      Physiolibrary.Hydraulic.Components.ElasticVesselElastance pulmonaryArteries(
          ...
          volume_start=3.904e-05,
          Elastance=49195960.956135)
          annotation (Placement(transformation(extent={{-19,-18},{19,18}},
              rotation=0,
              origin={-175,-30})));
        Physiolibrary.Hydraulic.Components.Resistor Rpul(Resistance(displayUnit="(mmHg.s)/ml")=
               20691634.526808) annotation (Placement(transformation(
          ...
          annotation (Placement(transformation(extent={{-18,-18},{18,18}},
              rotation=0,
              origin={-178,50})));
        Physiolibrary.Blocks.Types.Constants.PressureConst Pth1(k=-533.28954966)
          annotation (Placement(transformation(
              extent={{-6,-6},{6,6}},
              rotation=0,
              origin={-226,44})));
      ...
      package Parts
        extends Modelica.Icons.UtilitiesPackage;
          connector HydraulicElastanceInput = input
            Physiolibrary.Blocks.Types.HydraulicElastance
        ...
        connector HydraulicResistanceInput = input
            Physiolibrary.Blocks.Types.HydraulicResistance
        ...
        model pulsos "generates relative position in heart period from 0 to 1"
          discrete Physiolibrary.Blocks.Types.Time HP(start=0)
            "heart period - duration of cardiac cycle";
          Boolean b(start = false);
          Physiolibrary.Blocks.Types.RealIO.TimeOutput T0
            "start time of cardiac cycle";
          Physiolibrary.Blocks.Types.RealIO.FrequencyInput HR annotation (
              Placement(transformation(extent={{-158,20},{-118,60}}),
        ...
        model VariableElasticityGenerator
          ...
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceInput
            maxelastance annotation (Placement(transformation(extent={{-104,2},
                    {-64,42}}), iconTransformation(
                extent={{-14,-14},{14,14}},
                rotation=270,
                origin={-4,76})));
          Physiolibrary.Blocks.Types.RealIO.FrequencyInput heartRate
            annotation (Placement(transformation(extent={{-106,32},{-66,72}}),
                iconTransformation(
                extent={{-13,-13},{13,13}},
                rotation=270,
                origin={-37,77})));
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceOutput
            hydrauliccompliance annotation (Placement(transformation(extent={{
                    30,4},{50,24}}), iconTransformation(
                extent={{-10,-10},{10,10}},
                rotation=270,
                origin={-14,-14})));
          Curve                                     curve(x = {0, 0.0625, 0.125, 0.1875, 0.25, 0.3125, 0.375, 0.4375, 1}, y = {0.0066, 0.16, 0.32, 0.45, 0.625, 0.78, 0.27, 0.0066, 0.0066}, slope = {0, 0, 2.32, 2.44, 2.64, -2.84, -6.1872, 0, 0}) annotation(Placement(transformation(extent = {{-30, 48}, {-10, 68}})));
          HydraulicElastanceToCompliance                             hydrauliccompliance1 annotation(Placement(transformation(extent = {{0, 54}, {8, 62}})));
        equation
          ...
          connect(product1.y, hydrauliccompliance) annotation(Line(points={{11,17.5},
                  {11,14},{40,14}},                                                                         color = {0, 0, 127}, smooth = Smooth.None));
          connect(const.y, product1.u1) annotation(Line(points={{41,56},{42,56},{42,
                  29},{14,29}},                                                                            color = {0, 0, 127}, smooth = Smooth.None));
        ...
        model Heart
          ...
          replaceable
            Physiolibrary.Blocks.Types.Constants.HydraulicElastanceToComplianceConst
          ...
          Physiolibrary.Blocks.Types.Constants.HydraulicConductanceConst
            backflowConductance(k=0)
            annotation (Placement(transformation(extent={{-78,2},{-60,16}})));
          Physiolibrary.Blocks.Types.Constants.HydraulicResistanceToConductanceConst
        ...
        equation
          ...
          annotation(Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-120,
                    -60},{120,80}})),                                                                                     Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-120, -60}, {120, 80}}), graphics={
                  Text(
                  extent={{-98,48},{102,88}},
                  lineColor={0,0,0},
        ...
        model SystemicCirculation
          ...
          Physiolibrary.Hydraulic.Components.Conductor peripheralResistance(useConductanceInput = true) annotation(Placement(transformation(extent={{18,-12},
                    {-2,12}})));
          ...
          AortaFlowMeasurement                                     bloodFlowMeasurement annotation(Placement(transformation(extent = {{44, -12}, {24, 8}})));
        ...
        equation
          ...
          connect(peripheralVessels.q_in, peripheralResistance.q_out) annotation(Line(points={{-22,-2},
                  {-12,-2},{-12,0},{-2,0}},                                                                          color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
          connect(RPS.y, peripheralResistance.cond) annotation(Line(points={{10.25,
                  25},{10.25,25.5},{8,25.5},{8,7.2}},                                                                             color = {0, 0, 127}, smooth = Smooth.None));
          ...
          connect(peripheralResistance.q_in, bloodFlowMeasurement.q_out) annotation(Line(points={{18,0},{
                  22,0},{22,-2},{24,-2}},                                                                               color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
          connect(bloodFlowMeasurement.q_in, aorta.q_in) annotation(Line(points = {{44, -2}, {50, -2}, {50, 0}, {54, 0}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
          ...
          connect(q_in, aortaResistance.q_in) annotation (Line(
              ...
              thickness=1));
          annotation(Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-120,
                    -60},{120,60}})),                                                                                     Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-120, -60}, {120, 60}}), graphics={
                  Text(
                  extent={{-106,34},{94,74}},
                  lineColor={0,0,0},
                  textString="Fernandez")}));
        ...
        model PulmonaryCirculation
          extends Cardiovascular.Interfaces.Pulmonary;
          Physiolibrary.Hydraulic.Components.ElasticVessel pulmonaryArteries(useComplianceInput = true, ZeroPressureVolume = 0, volume_start = 0.00012) annotation(Placement(transformation(extent={{-20,-10},
                    {0,10}})));
          Physiolibrary.Blocks.Types.Constants.HydraulicElastanceToComplianceConst
            EPA(k=17771874.242419)
            annotation (Placement(transformation(extent={{-28,18},{-12,32}})));
          Physiolibrary.Hydraulic.Components.Conductor pulmonaryResistance(useConductanceInput = true) annotation(Placement(transformation(extent={{18,-10},
                    {38,10}})));
          Physiolibrary.Hydraulic.Components.ElasticVessel pulmonaryVeins(useComplianceInput = true, volume_start = 0.00024) annotation(Placement(transformation(extent={{52,-10},
                    {72,10}})));
          Physiolibrary.Blocks.Types.Constants.HydraulicElastanceToComplianceConst
            EPV(k=4399638.784695)
        ...
        equation
          connect(EPA.y, pulmonaryArteries.compliance) annotation(Line(points={{-10,25},
                  {-10,8}},                                                                             color = {0, 0, 127}, smooth = Smooth.None));
          connect(EPV.y, pulmonaryVeins.compliance) annotation(Line(points={{62.25,
                  25},{62.25,25.5},{62,25.5},{62,8}},                                                                            color = {0, 0, 127}, smooth = Smooth.None));
          connect(pulmonaryVeins.q_in, pulmonaryResistance.q_out) annotation(Line(points={{62,0},{
                  38,0}},                                                                                      color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
          connect(pulmonaryArteries.q_in, pulmonaryResistance.q_in) annotation(Line(points={{-10,0},
                  {18,0}},                                                                                        color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
          connect(RPV.y, pulmonaryResistance.cond) annotation(Line(points={{25.75,
                  24},{26,24},{26,6},{28,6}},                                                                            color = {0, 0, 127}, smooth = Smooth.None));
          ...
          connect(arteryResistance.q_in, q_in) annotation (Line(
              ...
              thickness=1));
          annotation(Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
                    -40},{100,40}})),                                                                                     Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -40}, {100, 40}}), graphics={
                  Text(
                  extent={{-98,10},{102,50}},
                  lineColor={0,0,0},
                  textString="Fernandez")}));
      ...
      equation
        ...
        model AortaFlowMeasurement
          ...
          import Physiolibrary.Blocks.Types.RealIO.*;
          import Physiolibrary.Blocks.Types.*;
    ...
    package Control "models of control mechanism and additional components"
      ...
      model Baroreceptor
        ...
        parameter Physiolibrary.Blocks.Types.Pressure PAOmedia=13465.561128915;
        parameter Physiolibrary.Blocks.Types.Frequency HR0Param=1.3333333333333
        ...
        Physiolibrary.Blocks.Types.RealIO.FrequencyInput cond(start=HR0Param)
           = HR0 if                                                               useHRInput
          annotation (Placement(transformation(extent={{-62,36},{-22,76}}),
              iconTransformation(
              extent={{-20,-20},{20,20}},
              rotation=180,
              origin={26,76})));
        Physiolibrary.Blocks.Types.RealIO.PressureInput PAo "pressure in aorta"
          annotation (Placement(transformation(extent={{2,-58},{42,-18}}),
              iconTransformation(
              extent={{-16,-16},{16,16}},
              rotation=0,
              origin={-76,-82})));
        Physiolibrary.Blocks.Types.RealIO.FrequencyOutput HR
          "heart rate - compatible with Const block" annotation (Placement(
              transformation(extent={{-76,60},{-56,80}}), iconTransformation(
              extent={{-15,-15},{15,15}},
              rotation=180,
              origin={-81,75})));
        Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceOutput evright
          annotation (Placement(transformation(extent={{80,22},{100,42}}),
              iconTransformation(
              extent={{-14,-14},{14,14}},
              rotation=180,
              origin={-76,10})));
        Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceOutput evleft
          annotation (Placement(transformation(extent={{78,-18},{98,2}}),
              iconTransformation(
              extent={{-16,-16},{16,16}},
              rotation=180,
              origin={-80,42})));
        Physiolibrary.Blocks.Types.HydraulicElastance evrightref;
        Physiolibrary.Blocks.Types.HydraulicElastance evleftref;
        Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceOutput evenacava
          annotation (Placement(transformation(extent={{78,-54},{98,-34}}),
              iconTransformation(
              extent={{-16,-16},{16,16}},
              rotation=180,
              origin={-78,-58})));
        Physiolibrary.Blocks.Types.RealIO.HydraulicConductanceOutput RS
          annotation (Placement(transformation(extent={{80,-90},{100,-70}}),
              iconTransformation(
              extent={{-14,-14},{14,14}},
              rotation=180,
              origin={-76,-24})));
        parameter Physiolibrary.Blocks.Types.HydraulicElastance EV0right=
            103991462.1837;
        parameter Physiolibrary.Blocks.Types.HydraulicElastance EV0left=
            106657909.932;
        parameter Physiolibrary.Blocks.Types.HydraulicCompliance EV0venacava=
            1.8751539396141e-006;
        parameter Physiolibrary.Blocks.Types.HydraulicResistance RS0(
            displayUnit="(mmHg.s)/ml") = 81793284.67910001;
        parameter Physiolibrary.Blocks.Types.Time activationDelay=15;
        //  parameter Physiolibrary.Types.HydraulicConductance Conductance=0
      protected
        Physiolibrary.Blocks.Types.Frequency HR0;
      ...
      package BloodVolume
        ...
        model Erythropoetin
          ...
          EPO_Physiolibrary.Chemical.Sensors.ConcentrationMeasure concentrationMeasure annotation(Placement(transformation(extent={{-21,-21},
                ...
                rotation=90,
                origin={-15,81})));
          Physiolibrary.Blocks.Types.RealIO.ConcentrationOutput concentration
            annotation (Placement(transformation(extent={{42,72},{62,92}}),
                iconTransformation(
                extent={{-21,-21},{21,21}},
                rotation=0,
                origin={121,3})));
          Physiolibrary.Blocks.Types.RealIO.PressureInput kidney_po2
            annotation (Placement(transformation(
                extent={{-20,-20},{20,20}},
                rotation=180,
          ...
          Physiolibrary.Blocks.Types.Constants.FractionConst
            hormoneFlowFraction(k=1)
            annotation (Placement(transformation(extent={{72,-28},{88,-20}})));
          Physiolibrary.Blocks.Types.Constants.MolarFlowRateConst molarFlowRate(
              k(displayUnit="mol/min") = 0.011166666666667)
        ...
        model KidneyFluidBalance
          ...
          Physiolibrary.Blocks.Types.RealIO.VolumeFlowRateOutput
            urineoutflowrate annotation (Placement(transformation(extent={{40,-80},
                    {60,-60}}), iconTransformation(extent={{40,-80},{60,-60}})));
          Physiolibrary.Blocks.Types.RealIO.VolumeInput plasmaticVolume
            annotation (Placement(transformation(extent={{46,-12},{86,28}}),
                iconTransformation(
                extent={{-13,-13},{13,13}},
                rotation=180,
                origin={47,-7})));
          parameter Physiolibrary.Blocks.Types.VolumeFlowRate Kud=
              4.6666666666667e-08;                                                //dehydratation
          parameter Physiolibrary.Blocks.Types.VolumeFlowRate Kuo=
              3.4666666666667e-07;                                                //overhydratation
          parameter Physiolibrary.Blocks.Types.VolumeFlowRate Jun=
              1.6666666666667e-08;
          discrete Physiolibrary.Blocks.Types.Volume Vpn;
        equation
          when {initial()} then
              Vpn = plasmaticVolume;
          end when;
        ...
        model RedBloodCells2
          ...
          Physiolibrary.Blocks.Types.Constants.PopulationChangeConst
          ...
          Physiolibrary.Blocks.Types.BusConnector busConnector
        ...
        model Plasma2
          ...
          Physiolibrary.Osmotic.Components.OsmoticCell plasma(
            Simulation=Physiolibrary.Blocks.Types.SimulationType.NoInit,
            NumberOfMembraneTypes=2,
        ...
        model VolumeRefill2
          ...
          Physiolibrary.Blocks.Types.Constants.VolumeFlowRateConst zeroRefill(k(
...
above 0 mmHg.")}));
        ...
        model BloodProperties
          ...
          Physiolibrary.Blocks.Types.Constants.FractionConst initialHematocrit(
              k=0.4)
        ...
        model DesiredFlowrate "control total blood volume"
          parameter Physiolibrary.Blocks.Types.Time flowtime=0.1;
          parameter Boolean enabled = true;
          Physiolibrary.Blocks.Types.RealIO.VolumeInput volume annotation (
              Placement(transformation(extent={{16,60},{56,100}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=270,
                origin={14,72})));
          Physiolibrary.Blocks.Types.RealIO.VolumeInput desiredVolume
            annotation (Placement(transformation(extent={{-72,56},{-32,96}}),
                iconTransformation(
                extent={{-20,-20},{20,20}},
                rotation=270,
                origin={-68,72})));
          Physiolibrary.Blocks.Types.RealIO.VolumeFlowRateOutput volumeflowrate
        ...
        model PlasmaBleeding
          extends Plasma2(
            ...
            plasma(Simulation=Physiolibrary.Blocks.Types.SimulationType.NoInit));
        equation
        ...
        model RBCBleeding
          extends RedBloodCells2(
            ...
            RBC(Simulation=Physiolibrary.Blocks.Types.SimulationType.NoInit));
        equation
      ...
      /*  Physiolibrary.Types.BusConnector busConnector annotation (Placement(
        transformation(extent={{-40,2},{0,42}}), iconTransformation(
          extent={{-38,4},{2,44}})));*/
        replaceable BloodVolume.Plasma2 plasma(plasma(Simulation=Physiolibrary.Blocks.Types.SimulationType.NoInit))
        ...
        replaceable BloodVolume.RedBloodCells2 redBloodCells(RBC(
              population_start=2, Simulation=Physiolibrary.Blocks.Types.SimulationType.NoInit))
  ...
  redBloodCells.RBC.state:=redBloodCells.InitialPopulation.y;")}),
      ...
      model BloodFlowMeasurement
        ...
        Physiolibrary.Blocks.Types.RealIO.VolumeOutput SV "systolic volume"
          annotation (Placement(transformation(extent={{22,-42},{42,-22}}),
              iconTransformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={32,-100})));
        Physiolibrary.Blocks.Types.RealIO.VolumeFlowRateOutput CO
          "Cardiac output" annotation (Placement(transformation(extent={{50,-40},
                  {70,-20}}), iconTransformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={52,-100})));
        Physiolibrary.Blocks.Types.Volume Volume(start=0)
        ...
        Boolean b;
        Physiolibrary.Blocks.Types.RealIO.FrequencyInput HR annotation (
            Placement(transformation(extent={{-14,58},{26,98}}),
              iconTransformation(
              extent={{-20,-20},{20,20}},
              rotation=270,
              origin={-60,100})));
  ...
  Pmean:=q_in.pressure;*/
    ...
    package Scenario "models of various scenarios"
      ...
      /*  Physiolibrary.Types.BusConnector busConnector annotation (Placement(
        ...
        Physiolibrary.Blocks.Types.Constants.HydraulicConductanceConst AVgon(k=
        ...
        Physiolibrary.Blocks.Types.Constants.HydraulicConductanceConst mvgoff(k
            =0) annotation (Placement(transformation(
              extent={{-10,-9},{10,9}},
              rotation=180,
              origin={66,-9})));
      ...
      package Stenosis
        ...
        model StenosisElastance
          parameter Physiolibrary.Blocks.Types.HydraulicElastance
            InitialElastance;
          parameter Physiolibrary.Blocks.Types.HydraulicElastance
            FinalElastance;
          parameter Physiolibrary.Blocks.Types.Time startTime(displayUnit="s")
             = 20;
          parameter Physiolibrary.Blocks.Types.Time duration(displayUnit="s")
             = 5;
          Physiolibrary.Blocks.Types.RealIO.HydraulicComplianceOutput
            hydrauliccompliance annotation (Placement(transformation(extent={{
        ...
        model StenosisResistance
          parameter Physiolibrary.Blocks.Types.HydraulicResistance
            InitialResistance;
          parameter Physiolibrary.Blocks.Types.HydraulicResistance
            FinalResistance;
          parameter Physiolibrary.Blocks.Types.Time startTime(displayUnit="s")
          ...
          parameter Physiolibrary.Blocks.Types.Time duration(displayUnit="s")
             = 5;
          Physiolibrary.Blocks.Types.RealIO.HydraulicConductanceOutput
            conductance annotation (Placement(transformation(extent={{48,-10},{
                    68,10}}), iconTransformation(
                extent={{-10,-10},{10,10}},
                rotation=90,
                origin={8,24})));
        equation
      ...
      model BleedingTransfusionBurkhoffInterface
        ...
        Physiolibrary.Blocks.Types.RealIO.VolumeFlowRateInput bleedrate
          annotation (Placement(transformation(extent={{-40,60},{0,100}}),
              iconTransformation(extent={{-40,60},{0,100}})));
        Physiolibrary.Blocks.Types.RealIO.VolumeFlowRateInput transrate
          annotation (Placement(transformation(extent={{-40,-106},{0,-66}}),
...
*/
      ...
      model BleedingTransfusionRate
        ...
        Physiolibrary.Blocks.Types.RealIO.VolumeFlowRateOutput bleedrate
          annotation (Placement(transformation(extent={{80,80},{100,100}}),
              iconTransformation(extent={{80,80},{100,100}})));
        Physiolibrary.Blocks.Types.RealIO.VolumeFlowRateOutput transrate
          annotation (Placement(transformation(extent={{80,22},{100,42}}),
    ...
    package Complex
      ...
      package Settings "Central model settings"
        ...
        model Settings "Class encompassing all settings"
          ...
          inner replaceable Conditions.Rest_NoAdapt condition
            constrainedby Conditions.Abstraction.Condition
            "Selected global condition and adaptation"
            annotation (choicesAllMatching=true);

          replaceable Supports.No supports
            constrainedby Supports.Abstraction.Supports
          ...
          replaceable ModelConstants.Standard constants
            constrainedby ModelConstants.Standard
    ...
    You can find it in Cardiovascular.Model.Complex.Settings.",
                  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
                    {100,100}}), graphics={Bitmap(extent={{-108,-106},{108,110}},
                  fileName="modelica://Cardio/../../../../../../Settings.png")}));
        ...
        package Conditions "Setting global condition including adaptation"
          ...
          model Rest_NoAdapt "Resting condition with no adaptation"
            extends Conditions.Abstraction.Condition(
              adaptCapillaryResistance = false);
          ...
          model AdaptationProtocol
            ...
            extends Conditions.Abstraction.Condition(
              cycleDuration = if mode < 2 then adaptRest. cycleDuration else adaptEx. cycleDuration,
              adaptCapillaryResistance = true,
              ...
              aortalFlowRef = if mode < 2 then adaptRest. aortalFlowRef else adaptEx. aortalFlowRef,
              bloodVolumeRef = if mode < 2 then adaptRest. bloodVolumeRef else adaptEx. bloodVolumeRef,
            ...
            redeclare partial function ProcessFeedback
              ...
              output Real result = if error < 1e-2 then (if mode > 0 then (if inEndPhase and mode >= 1 and mode <= 1.25 then mode else mod(mode + 0.25, 4)) else mode + 0.25) else mode
                "New mode";
            algorithm
            end ProcessFeedback;
        ...
        package Supports "Settings of cardiac supports"
          ...
          record No "No supports are applied"
            extends Supports.Abstraction.Supports(
              ECMO_isEnabled = false,
          ...
          record ECMO_Nonpulsatile "ECMO enabled in non-pulsatile mode"
            extends Supports.No(
              ECMO_isEnabled = true,
              ECMO_pulseShapeRef = PulseShape. pulseless);
            import Cardiovascular.Types.*;
          ...
          record ECMO_Pulsatile "ECMO enabled in pulsatile mode"
            extends Supports.No(
              ECMO_isEnabled = true,
              ECMO_pulseShapeRef = PulseShape. parabolic);
            import Cardiovascular.Types.*;
        ...
        package Auxiliary "Auxiliary components"
          ...
          package BlockKinds "Fundamental types of blocks"
            partial model Port "Block with flow through"
              ...
              Connectors.In cIn "Inflow"
                annotation (Placement(transformation(extent={{-90,-10},{-70,10}})));
              Connectors.Out cOut "Outflow"
            ...
            model Hook "Block for intercepting flow"
              ...
              Connectors.Through c "Hooking connector"
                annotation (Placement(transformation(extent={{-10,40},{10,60}}), iconTransformation(extent={{-10,40},{10,60}})));

              annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
                      extent={{-100,-100},{100,100}}), graphics), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics));
            end Hook;
          end BlockKinds;
          ...
          package Analyzers
            ...
            package Abstraction "Common ancestors"
              partial class Analyzer
                ...
                replaceable type T = Real constrainedby Real
                  "Signal type - to guarantee a unit control"                                            annotation(choicesAllMatching=true);
            ...
            protected
              T integral(start = 0) "Integral of the input signal";  // Setting fixed=true for those two variables wouldn't compile in Dymola 2014; in Dymola 2015 FD01 it would be OK
            ...
            equation
              ...
              when change(control) then
                average = (if pre(t) == 0 then 0 else pre(integral) / pre(t)) * unit;
                reinit(integral, 0);
                reinit(t, 0);
              end when;
            ...
            equation
              ...
              when {change(control), sample(0, 1e-2)} then
                maximum = if change(control) then 0 elseif condition then max(pre(maximum), pre(signal)) else pre(maximum);
              end when;
          ...
          package RLC "Components with RLC characteristics"
            ...
            package Compounds "RLC circuits"
              ...
              model CLR "Constant CLR segment"
                ...
                Elements.L inductor(L = L) annotation (Placement(transformation(
                        extent={{-10,-10},{10,10}})));
                Elements.R resistor(R = R) annotation (Placement(transformation(extent={{30,-10},{50,10}})));
              ...
              model CRL "Constant CRL segment"
                ...
                Elements.C capacitor(C = C) annotation (Placement(transformation(
                      ...
                      rotation=0,
                      origin={-40,-6})));
                Elements.L inductor(L = L) annotation (Placement(transformation(extent={{30,-10},{50,10}})));
                Elements.R resistor(R = R) annotation (Placement(transformation(
                        extent={{-10,-10},{10,10}})));
              ...
              model CLpRR "Constant C(L|R)R segment"
                ...
                Elements.R resistorPar(R = Rp) annotation (Placement(transformation(extent={{-10,10},{10,30}})));
              ...
              model CRLpR "Constant CR(L|R) segment"
                ...
                Elements.R resistorPar(R = Rp) annotation (Placement(transformation(extent={{30,14},{50,34}})));
              ...
              model RRcC "Constant R(R-C) segment"
                ...
                Elements.R resistor(R = R) annotation (Placement(transformation(
                        extent={{-50,-10},{-30,10}})));
                Elements.R resistorC(R = Rc) annotation (Placement(
                      transformation(
                      extent={{-10,-10},{10,10}},
                      rotation=-90,
                      origin={22,-8})));
              ...
              equation
                ...
                annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                          -100},{100,100}}), graphics), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Text(
                        extent={{-32,26},{32,-24}},
                        lineColor={0,0,0},
                        fillColor={255,255,255},
                        fillPattern=FillPattern.Solid,
            ...
            package Tubes "Geometrical tubes with RLC characteristics"
              package Abstraction "Common ancestors"
                model Tube "Tube segment"
                  ...
                  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(extent={{-80,-72},{80,70}},
                          fileName="modelica://Cardio/../../../../../../resistance.png")}));
              ...
              model TubeRLC_Derived
                ...
                parameter HydraulicResistance Rb = if isBranching then h / r * qRb else 0
                  "Branching resistance";
                parameter HydraulicResistance Rc = if isCannulated then 8 * mu * cannulaOuterDiameter / pi * (1 / (((cannulaOuterDiameter * pi * r ^ 2 - cannulaDepth * pi * (cannulaOuterDiameter / 2) ^ 2) / cannulaOuterDiameter / pi) ^ 0.5) ^ 4 - 1 / r ^ 4) else 0
              ...
              model TubeRLC_Derived_IABP
                ...
                extends TubeRLC_Derived(
                  resistor(R=(if enableIABP then R / (1 - xi ^ 4 - (1 - xi ^ 2) ^ 2 / log(xi)) else R) + Rb + Rc),
                ...
                Pressure pIABP(start = if tInflation < tDeflation then pIABPdeflated else pIABPinflated)
                ...
                Elements.C capacitorIABP(C = 0.1 * C, pGround = pIABP) if enableIABP annotation (Placement(
                      transformation(extent={{24,-46},{44,-26}})));
                Elements.C capacitorIABP2(C = 0.1 * C, pGround = pIABP) if useIABP2 and enableIABP annotation (Placement(
              ...
              equation
                ...
                if enableIABP then
                  inflation = t >= tInflation and t <= tInflation + flationDuration or t + cycleDuration >= tInflation and t + cycleDuration <= tInflation + flationDuration;
                  deflation = t >= tDeflation and t <= tDeflation + flationDuration or t + cycleDuration >= tDeflation and t + cycleDuration <= tDeflation + flationDuration;
                  if inflation then
                    der(rIABP) = (rIABPinflated - rIABPdeflated) / flationDuration;
                    der(pIABP) = (pIABPinflated - pIABPdeflated) / flationDuration;
                  elseif deflation then
                    der(rIABP) = (rIABPdeflated - rIABPinflated) / flationDuration;
                    der(pIABP) = (pIABPdeflated - pIABPinflated) / flationDuration;
                  else
                    der(rIABP) = 0;
                    der(pIABP) = 0;
                  end if;
        ...
        package Main "Main components of cardiovascular circuits"
          package Heart "Heart and its subparts"
            ...
            model Heart "Heart model including coronaries"
              ...
              Volume VP = RA. V + LA. V + ventricles. VLV + ventricles. VRV + ventricles. LW. VW + ventricles. SW. VW + ventricles. RW. VW + RA. VW + LA. VW
                "Current pericardial volume";

              Ventricles ventricles(pP = pP)
                annotation (Placement(transformation(extent={{-32,-110},{28,-50}})));
              AtrialWall LA(
                ...
                tauA = settings. initialization. LA_tauA_Base + settings. initialization. LA_tauA_CycleFraction * settings. condition. cycleDuration,
              ...
              AtrialWall RA(
                ...
                tauA = settings. initialization. RA_tauA_Base + settings. initialization. RA_tauA_CycleFraction * settings. condition. cycleDuration,
              ...
              Valve vLAV(
                ...
                dpC = settings. initialization. vLAV_dpC)
                annotation (Placement(transformation(
              ...
              Valve vRAV(
                ...
                dpC = settings. initialization. vRAV_dpC)
                annotation (Placement(transformation(
                    extent={{-10,-10},{10,10}},
                    rotation=-55,
                    origin={-32,-56})));
              Valve vSA(
                ...
                dpC = settings. initialization. vSA_dpC)
                annotation (Placement(transformation(
                    extent={{-10,-10},{10,10}},
                    rotation=89,
                    origin={10,-40})));
              Valve vPA(
                ...
                dpC = settings. initialization. vPA_dpC)
                annotation (Placement(transformation(
                    extent={{-10,-10},{10,10}},
                    rotation=89,
                    origin={-10,-40})));
              Valve vSV(
                ...
                dpC = settings. initialization. vSV_dpC)
                annotation (Placement(transformation(
                    extent={{-10,-10},{10,10}},
                    rotation=-91,
                    origin={-44,0})));
              Valve vPV(
                ...
                dpC = settings. initialization. vPV_dpC)
                annotation (Placement(transformation(
                    extent={{-10,-10},{10,10}},
                    rotation=-91,
                    origin={34,10})));
            ...
            equation
              ...
              connect(RA.c, Coro. cOut) annotation (Line(
                  points={{-45,-23.5},{-40,-23.5},{-40,-12},{-28,-12},{-28,-10},{-28,-12},{-27.8,
                      -12},{-27.8,-11}},
                  color={127,5,58},
                  smooth=Smooth.Bezier,
                  thickness=1));
              ...
              annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                        -100},{100,100}}), graphics), Icon(coordinateSystem(
                      preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={
                      Bitmap(extent={{-104,-100},{94,98}},
                      fileName="modelica://Cardio/14157-medical-illustration-of-a-human-heart-or.png")}));
            end Heart;
            ...
            equation
              ...
              annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(extent={{-130,-202},{130,202}},
                      fileName="modelica://Cardio/../../../../../../Valve.png",
                      origin={8,2},
                      rotation=90)}));
            end Valve;
...
<p>from triseg nodel</p>
</html>"),     Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(extent={{-104,-134},{130,74}},
                      fileName="modelica://Cardio/../../../../../../Atrium.png")}));
            end AtrialWall;
            ...
            public
              ...
              VentricularWall LW(
                ...
                tauA = settings. initialization. LW_tauA_Base + settings. initialization. LW_tauA_CycleFraction * settings. condition. cycleDuration,
              ...
              VentricularWall SW(
                ...
                tauA = settings. initialization. SW_tauA_Base + settings. initialization. SW_tauA_CycleFraction * settings. condition. cycleDuration,
              ...
              VentricularWall RW(
                ...
                tauA = settings. initialization. RW_tauA_Base + settings. initialization. RW_tauA_CycleFraction * settings. condition. cycleDuration,
            ...
            equation
              ...
              annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                        -100},{100,100}}), graphics), Icon(coordinateSystem(
                      preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={
                      Bitmap(extent={{-128,-88},{98,98}},
                      fileName="modelica://Cardio/../../../../../../Ventricles.png")}));
            end Ventricles;
          ...
          package Vessels "Human vessels"
            package Abstraction "Common ancestors"
              partial model Vessels "General block for vessels"
                ...
                PressureOutput pInner "Output pressure for cappilary control" annotation (Placement(transformation(
                      extent={{-10,-10},{10,10}},
                      rotation=-90,
              ...
              model Capillaries "Port for capillaries"
                ...
                PressureInput pIn
                  annotation (Placement(transformation(extent={{-66,-90},{-26,-50}}),
            ...
            model AdaptableArteries
              ...
              annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(
                      ...
                      fileName="modelica://Cardio/../../../../../../Vessels.png",
            ...
            model AdaptableVeins
              extends Abstraction.AdaptableVessels;
              annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(
                      extent={{-52.9337,87.2333},{52.9337,-87.2333}},
                      fileName="modelica://Cardio/../../../../../../Veins.png",
                      origin={-3.052,8.24256},
                      rotation=-68)}));
            ...
            model CoronaryVessels "Flow port for coronary vessels"
              ...
              import Physiolibrary.Blocks.Types.Volume;
            ...
            equation
              ...
              connect(Ra. cOut, Rm1. cIn)
                annotation (Line(points={{-40,0},{-24,0}}, smooth=Smooth.None));
              ...
              connect(cOut, Rv. cOut)
                annotation (Line(points={{80,0},{56,0}}, smooth=Smooth.None));
              connect(Rm1. cIn, Ca. c) annotation (Line(points={{-24,0},{-32,0},{-32,-25},{-30,-25}},
                             smooth=Smooth.None));
              connect(Rm2. cOut, Cv. c)
                annotation (Line(points={{24,0},{24,-25},{30,-25}}, smooth=Smooth.None));
              connect(Rm1. cOut, Cm. c)
                annotation (Line(points={{-8,0},{-8,-25},{0,-25}}, smooth=Smooth.None));

               annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                        -100},{100,100}}), graphics), Icon(graphics={Bitmap(extent={{-96,-64},{96,58}},
                      fileName="modelica://Cardio/../../../../../../Capillaries.png")}));
            end CoronaryVessels;

            model ConsumingCapillaries
              "Capillaries visualized as consuming oxygen"
              extends Abstraction.Capillaries;
              annotation (Icon(graphics={      Bitmap(extent={{-96,-64},{96,58}},
                      fileName="modelica://Cardio/../../../../../../Capillaries.png")}));
            ...
            model OxygenatingCapillaries
              ...
              extends Abstraction.Capillaries;
              annotation (Icon(graphics={      Bitmap(extent={{-96,-61},{96,61}},
                      fileName="modelica://Cardio/../../../../../../Capillaries.png",
                      origin={0,-3},
                      rotation=179)}));
          ...
          package SystemicArteries "Various realizations of systemic arteries"
            package Abstraction "Common ancestors"
              partial model SystemicArteries
                ...
                In cCannula "Location for connecting ECMO cannula"
                  annotation (Placement(transformation(
                      extent={{-10,-10},{10,10}},
                      rotation=60,
                      origin={-60,-12})));
            ...
            model Original_CircAdapt
              ...
              extends Abstraction.SystemicArteries(
                isAdaptable = true);
            ...
            equation
              ...
              annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
                      extent={{-100,-100},{100,100}}), graphics), Icon(coordinateSystem(
                      preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={
                      Text(
                      extent={{-52,52},{28,16}},
                      lineColor={0,128,0},
            ...
            model Aorta_Ferrari "Model of aorta by Ferrari et al. (2005)"
              ...
              TubeRLC_Ferrari ascendingAorta(
                l=0.04,
                r=0.01455,
                h=0.00163) annotation (Placement(transformation(extent={{-70,36},{-50,56}})));
              TubeRLC_Ferrari aorticArch1(
                l=0.02,
                r=0.0112,
                h=0.00132) annotation (Placement(transformation(extent={{-44,56},{-24,76}})));
              TubeRLC_Ferrari aorticArch2(
                l=0.039,
                r=0.0107,
                h=0.00127) annotation (Placement(transformation(extent={{4,52},{24,72}})));
              TubeRLC_Ferrari thoracicAorta1(
                l=0.052,
                r=0.00999,
                h=0.0012) annotation (Placement(transformation(extent={{14,24},{34,44}})));
              TubeRLC_Ferrari thoracicAorta2(
                l=0.052,
                r=0.006675,
                h=0.0009) annotation (Placement(transformation(extent={{22,-8},{42,12}})));
              TubeRLC_Ferrari thoracicAorta3(
                l=0.052,
                r=0.006525,
                h=0.00087) annotation (Placement(transformation(extent={{30,-36},{50,-16}})));
              TubeRLC_Ferrari abdominalAorta1(
                l=0.053,
                r=0.0061,
                h=0.00084) annotation (Placement(transformation(extent={{38,-64},{58,-44}})));
              TubeRLC_Ferrari abdominalAorta2(
                l=0.106,
                r=0.00564,
                h=0.0008) annotation (Placement(transformation(extent={{44,-88},{64,-68}})));
              RRcC arms(
                R=18200e5/4,
                Rc=770e5/4,
                C=9.685e-10) annotation (Placement(transformation(extent={{-28,88},{-8,108}})));
              RRcC leftBrain(
                R=72000e5/4,
                Rc=1000e5/4,
                C=5.188e-10) annotation (Placement(transformation(extent={{-6,78},{14,98}})));
              RRcC rightBrain(
                R=10600e5/4,
                Rc=380e5/4,
                C=1.3089e-10) annotation (Placement(transformation(extent={{16,74},{36,94}})));
              R intercostal1(R=190000e5/4) annotation (Placement(transformation(extent={{30,44},{50,64}})));
              R intercostal2(R=190000e5/4) annotation (Placement(transformation(extent={{42,24},{62,44}})));
              R intercostal3(R=190000e5/4) annotation (Placement(transformation(extent={{46,2},{66,22}})));
              R intercostal4(R=190000e5/4) annotation (Placement(transformation(extent={{48,-22},{68,-2}})));
              RC hepaticCirculation(R=11000e5/4, C=1.79e-10) annotation (Placement(transformation(extent={{56,-44},{76,-24}})));
              RC rightKidney(R=11000e5/4, C=3.29e-11) annotation (Placement(transformation(extent={{64,-68},{84,-48}})));
              RC leftKidneyAndUpperMesenteric(R=5200e5/4, C=2.11e-10) annotation (Placement(transformation(extent={{74,-90},{94,-70}})));
              RRcC legsAndLowerMesenteric(
                R=7780e5/4,
                Rc=415e5/4,
                C=1.25e-11) annotation (Placement(transformation(extent={{68,-112},{88,-92}})));
            ...
            equation
              ...
              if settings. supports. ECMO_isEnabled then
                ...
                elseif settings. supports. ECMO_cannulaPlacement == CannulaPlacement. aorticArch1 then
                  connect(cCannula, aorticArch1. cIn);
                elseif settings. supports. ECMO_cannulaPlacement == CannulaPlacement. aorticArch2 then
                  connect(cCannula, aorticArch2. cIn);
                elseif settings. supports. ECMO_cannulaPlacement == CannulaPlacement. thoracicAorta1 then
                  connect(cCannula, thoracicAorta1. cIn);
                elseif settings. supports. ECMO_cannulaPlacement == CannulaPlacement. thoracicAorta2 then
              ...
              connect(thoracicAorta2.cOut, thoracicAorta3.cIn) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(thoracicAorta3.cOut, abdominalAorta1.cIn) annotation (Line(
                  points={{48,-26},{44,-26},{44,-54},{40,-54}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta1.cOut, abdominalAorta2.cIn) annotation (Line(
              ...
              connect(aorticArch1.cOut, rightBrain.cIn) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta1.cIn, hepaticCirculation.cIn) annotation (Line(
              ...
              connect(abdominalAorta2.cIn, rightKidney.cIn) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta2.cIn, leftKidneyAndUpperMesenteric.cIn) annotation (Line(
                  points={{46,-78},{60,-78},{60,-80},{76,-80}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta2.cOut, legsAndLowerMesenteric.cIn) annotation (Line(
            ...
            model Tree_Abdolrazaghi
              ...
              Volume V = ascendingAorta. V + aorticArch1. V + aorticArch2. V + thoracicAorta1. V + thoracicAorta2. V + abdominalAorta1. V + abdominalAorta2And3. V + abdominalAorta4. V + abdominalAorta5. V
                ...
                + rightCommonCarotid. V + rightInteriorCarotid. V + rightExteriorCarotid. V + leftCommonCarotid. V + leftInteriorCarotid. V + leftExteriorCarotid. V + leftSubclavian. V + rightSubclavian. V
                + leftCommonIlliac. V + leftExternalIlliac. V + leftFemoral. V + rightCommonIlliac. V + rightExternalIlliac. V + rightFemoral. V
                + superiorMesenteric. V + inferiorMesenteric. V + arterioles. V
                "Current volume";
              ...
              CLR rightFemoral(
                C=1.8126e-10,
                L=30545610,
                R=87740000) annotation (Placement(transformation(extent={{-16,-100},{-36,-80}})));
              CLR leftFemoral(
                C=1.8126e-10,
                L=30545610,
                R=87740000) annotation (Placement(transformation(extent={{-16,-80},{-36,-60}})));
              CLR rightExternalIlliac(
                C=1.0483e-10,
                L=6504400,
                R=12230000) annotation (Placement(transformation(extent={{2,-100},{-18,-80}})));
              CLR leftExternalIlliac(
                C=1.0483e-10,
                L=6504400,
                R=12245000) annotation (Placement(transformation(extent={{2,-80},{-18,-60}})));
              ...
              CLpRR abdominalAorta5(
                ...
                L=164820,
                R=121960,
                Rp=519650) annotation (Placement(transformation(extent={{44,-90},{24,-70}})));
              ...
              CRLpR ascendingAorta(
                ...
                R=7540,
                L=82500,
                Rp=32550) annotation (Placement(transformation(extent={{0,80},{20,100}})));
              CLpRR thoracicAorta1(
                C=5.5664e-10,
                L=231750,
                R=46370,
                Rp=197570) annotation (Placement(transformation(extent={{58,80},{78,100}})));
              CLpRR thoracicAorta2(
                C=3.7662e-10,
                L=1017300,
                R=446730,
                Rp=1903460) annotation (Placement(transformation(extent={{78,80},{98,100}})));
              CLR inferiorMesenteric(
                C=5.6082e-12,
                L=9033880,
                R=1662000000) annotation (Placement(transformation(extent={{44,-64},{24,-44}})));
              CRL superiorMesenteric(
                C=8.2877e-11,
                R=192000000,
                L=1442180) annotation (Placement(transformation(extent={{44,-44},{24,-24}})));
              CRL leftRenal(
                C=1.2496e-11,
                R=126000000,
                L=2189510) annotation (Placement(transformation(extent={{68,-12},{48,8}})));
              CRL rightRenal(
                C=1.2496e-11,
                R=126000000,
                L=2189510) annotation (Placement(transformation(extent={{68,-32},{48,-12}})));
              CLpRR splenetic(
                C=2.857e-11,
                L=3853180,
                R=254000000,
                Rp=1117000000) annotation (Placement(transformation(extent={{80,14},{60,34}})));
              CLpRR gastric(
                C=1.0835e-11,
                L=10135800,
                R=254000000,
                Rp=1117000000) annotation (Placement(transformation(extent={{80,34},{60,54}})));
              CLpRR hepatic(
                C=1.688e-11,
                L=6033700,
                R=254000000,
                Rp=1117000000) annotation (Placement(transformation(extent={{80,54},{60,74}})));
              CLR leftSubclavian(
                C=4.8542e-10,
                L=12018410,
                R=14118000) annotation (Placement(transformation(extent={{-16,-54},{-36,-34}})));
              CLR leftCommonCarotid(
                C=1.9692e-10,
                L=7027560,
                R=9890000) annotation (Placement(transformation(extent={{-10,-30},{-30,-10}})));
              CRL leftInteriorCarotid(
                C=2.5538e-11,
                R=159800000,
                L=25984280) annotation (Placement(transformation(extent={{-32,-40},{-52,-20}})));
              CLR leftExteriorCarotid(
                C=2.7517e-11,
                L=26131920,
                R=160720000) annotation (Placement(transformation(extent={{-32,-20},{-52,0}})));
              CLR rightSubclavian(
                C=4.8904e-10,
                L=11958990,
                R=5349000) annotation (Placement(transformation(extent={{-14,4},{-34,24}})));
              CLR rightCommonCarotid(
                C=1.6757e-10,
                L=5980180,
                R=3153000) annotation (Placement(transformation(extent={{-6,30},{-26,50}})));
              CLR rightExteriorCarotid(
                C=2.7517e-11,
                L=26131920,
                R=160800000) annotation (Placement(transformation(extent={{-26,20},{-46,40}})));
              CLR rightInteriorCarotid(
                C=2.5538e-11,
                L=25984280,
                R=159800000) annotation (Placement(transformation(extent={{-26,38},{-46,58}})));
              CLpRR aorticArch2(
                C=4.8919e-10,
                L=151820,
                R=26530,
                Rp=113050) annotation (Placement(transformation(extent={{40,80},{60,100}})));
              CRLpR aorticArch1(
                C=2.6259e-10,
                R=11330,
                L=71060,
                Rp=48290) annotation (Placement(transformation(extent={{20,80},{40,100}})));
            ...
            equation
              ...
              connect(arterioles.cIn, leftFemoral.cOut) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(rightFemoral.cIn, rightExternalIlliac.cOut) annotation (Line(
                  points={{-18,-90},{-16,-90}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(leftFemoral.cIn, leftExternalIlliac.cOut) annotation (Line(
                  points={{-18,-70},{-16,-70}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(rightExternalIlliac.cIn, rightCommonIlliac.cOut) annotation (Line(
                  points={{0,-90},{2,-90}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(leftExternalIlliac.cIn, leftCommonIlliac.cOut) annotation (Line(
                  points={{0,-70},{2,-70}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(leftCommonIlliac.cIn, abdominalAorta5.cOut) annotation (Line(
                  points={{18,-70},{22,-70},{22,-80},{26,-80}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(rightCommonIlliac.cIn, abdominalAorta5.cOut) annotation (Line(
                  points={{18,-90},{22,-90},{22,-80},{26,-80}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta5.cIn, abdominalAorta4.cOut) annotation (Line(
                  points={{42,-80},{66,-80},{66,-58},{90,-58}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta4.cIn, abdominalAorta2And3.cOut) annotation (Line(
                  points={{90,-42},{90,-34}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta2And3.cIn, abdominalAorta1.cOut) annotation (Line(
                  points={{90,-18},{90,-10}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(thoracicAorta1.cOut, thoracicAorta2.cIn) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(thoracicAorta2.cOut, abdominalAorta1.cIn) annotation (Line(
                  points={{96,90},{94,90},{94,6},{90,6}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta4.cOut, inferiorMesenteric.cIn) annotation (Line(
                  points={{90,-58},{66,-58},{66,-54},{42,-54}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(abdominalAorta2And3.cOut, superiorMesenteric.cIn) annotation (Line(
                  points={{90,-34},{42,-34}},
                  color={0,0,255},
                  smooth=Smooth.None));
              ...
              connect(arterioles.cIn, hepatic.cOut) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(leftCommonCarotid.cOut, leftInteriorCarotid.cIn) annotation (Line(
                  points={{-28,-20},{-30,-20},{-30,-30},{-34,-30}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(leftCommonCarotid.cOut, leftExteriorCarotid.cIn) annotation (Line(
              ...
              connect(arterioles.cIn, leftSubclavian.cOut) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(arterioles.cIn, leftInteriorCarotid.cOut) annotation (Line(
                  points={{-50,-80},{-50,-30}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(arterioles.cIn, leftExteriorCarotid.cOut) annotation (Line(
                  points={{-50,-80},{-50,-10}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(rightCommonCarotid.cOut, rightExteriorCarotid.cIn) annotation (Line(
                  points={{-24,40},{-26,40},{-26,30},{-28,30}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(rightCommonCarotid.cOut, rightInteriorCarotid.cIn) annotation (Line(
              ...
              connect(arterioles.cIn, rightSubclavian.cOut) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(arterioles.cIn, rightExteriorCarotid.cOut) annotation (Line(
                  points={{-50,-80},{-48,-80},{-48,30},{-44,30}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(arterioles.cIn, rightInteriorCarotid.cOut) annotation (Line(
              ...
              connect(aorticArch1.cOut, leftSubclavian.cIn) annotation (Line(
                  ...
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(ascendingAorta.cOut, rightSubclavian.cIn) annotation (Line(
                  points={{18,90},{2,90},{2,14},{-16,14}},
                  color={0,0,255},
                  smooth=Smooth.None));
              connect(ascendingAorta.cOut, rightCommonCarotid.cIn) annotation (Line(
            ...
            model ComplexTree_Derived "Derived arterial tree"
              ...
              inner parameter Boolean enableIABP = settings. supports. _DT_IABP_isEnabled
                "Whether IABP is implanted";
              inner parameter Time tDeflation = settings. supports. _DT_IABP_deflationTime
                "Time of IABP deflation with respect to start of the cardiac cycle";
              inner parameter Time tInflation = settings. supports. _DT_IABP_inflationTime
              ...
              parameter Fraction aorticArchStenosisRatio = settings. condition. _DT_aorticArchStenosisRatio
              ...
              Volume V = ascendingAorta. V + aorticArch1. V + leftSubclavian1. V + leftCommonCarotid1. V + aorticArch2. V + brachiocephalic. V + leftInternalMammary. V + leftSubclavian2. V + leftVertebral. V + leftCommonCarotid2. V
                 + thoracicAorta1. V + rightCommonCarotid1. V + rightVertebral. V + rightSubclavian. V + righInternalMammary. V + leftCostocervical. V + leftAxilliary1. V + leftSuprascapular. V + leftThyrocervical. V + leftCommonCarotid3. V
                 + thoracicAorta2. V + rightCommonCarotid2. V + rightThyrocervical. V + rightSuprascapular. V + rightAxilliary1. V + rightCostocervical. V + leftThoracoacrominal. V + leftAxilliary2. V + leftCircumflexScapular. V + leftSubscapular. V
                 + leftInternalCarotid1. V + leftExternalCarotid. V + leftSuperiorThyroid. V + thoracicAorta3. V + rightSuperiorThyroid. V + rightExternalCarotid. V + rightInternalCarotid1. V + rightSubscapular. V + rightCircumflexScapular. V + rightAxilliary2. V
                 + rightThoracoacrominal. V + leftBrachial1. V + leftLingual. V + leftInternalCarotid2. V + leftFacial. V + leftMiddleCerebral. V + leftCerebral. V + leftOpthalmic. V + coeliac. V + abdominalAorta1. V
                 + rightOpthalmic. V + rightCerebral. V + rightMiddleCerebral. V + rightFacial. V + rightInternalCarotid2. V + rightLingual. V + rightBrachial1. V + leftProfundaBrachi. V + leftBrachial2. V + leftInternalCarotid3. V
                 + gastric1. V + splenic. V + hepatic. V + renal. V + abdominalAorta2. V + superiorMesenteric. V + gastric2. V + rightInternalCarotid3. V + rightBrachial2. V + rightProfundaBrachi. V
                 + leftBrachial3. V + leftSuperiorUlnarCollateral. V + leftSuperficialTemporal. V + leftMaxilliary. V + abdominalAorta3. V + rightMaxilliary. V + rightSuperficialTemporal. V + rightSuperiorUlnarCollateral. V + rightBrachial3. V + leftInferiorUlnarCollateral. V
                 + leftBrachial4. V + leftCommonIlliac. V + inferiorMesenteric. V + rightCommonIlliac. V + rightBrachial4. V + rightInferiorUlnarCollateral. V + leftUlnar1. V + leftRadial1. V + leftExternalIlliac1. V + leftInternalIlliac. V
                 + rightInternalIlliac. V + rightExternalIlliac1. V + rightRadial1. V + rightUlnar1. V + leftUlnar2. V + leftInterossea. V + leftRadial2. V + leftExternalIlliac2. V + rightExternalIlliac2. V + rightRadial2. V
                 + rightInterossea. V + rightUlnar2. V + leftUlnar3. V + leftFemoral1. V + leftProfundis. V + rightProfundis. V + rightFemoral1. V + rightUlnar3. V + leftFemoral2. V + rightFemoral2. V
              ...
              TubeRLC_Derived ascendingAorta(
                ...
                r = 0.0145,
                h = 0.00163,
                E = 4e5) annotation (Placement(transformation(extent={{-64,52},{-68,56}})));

              TubeRLC_Derived aorticArch1(
                isCannulated = enableECMO and cannulaPlacement == CannulaPlacement. aorticArch1,
                l = 2e-2,
                r = 1.12e-2 * (1 - aorticArchStenosisRatio),
                h = 0.132e-2 + 1.12e-2 * aorticArchStenosisRatio,
                E = 4e5) annotation (Placement(transformation(extent={{-62,54},{-66,58}})));
              ...
              TubeRLC_Derived leftSubclavian1(
                ...
                r = 0.42e-2,
                h = 0.067e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-52,60},{-56,64}})));
              ...
              TubeRLC_Derived leftCommonCarotid1(
                ...
                r = 0.37e-2,
                h = 0.063e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-52,66},{-48,70}})));

              TubeRLC_Derived aorticArch2(
                isCannulated = enableECMO and cannulaPlacement == CannulaPlacement. aorticArch2,
                isBranching = true,
                l = 3.9e-2,
              ...
              TubeRLC_Derived brachiocephalic(
                ...
                r = 0.62e-2,
                h = 0.086e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-64,60},{-60,64}})));
              ...
              TubeRLC_Derived leftInternalMammary(
                ...
                r = 0.1e-2,
                h = 0.03e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-48,58},{-44,62}})));
              TubeRLC_Derived leftSubclavian2(
                isBranching = true,
                l = 6.8e-2,
                r = 0.4e-2,
                h = 0.066e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-42,62},{-46,66}})));
              ...
              TubeRLC_Derived leftVertebral(
                ...
                r = 0.19e-2,
                h = 0.045e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-48,56},{-44,60}})));
              TubeRLC_Derived leftCommonCarotid2(
                l = 8.9e-2,
                r = 0.37e-2,
                h = 0.063e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-52,68},{-48,72}})));

              TubeRLC_Derived_IABP thoracicAorta1(
                isCannulated = enableECMO and cannulaPlacement == CannulaPlacement. thoracicAorta1,
                useIABP2 = true,
                l = 5.2e-2,
                r = 1e-2,
                h = 0.12e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-60,50},{-56,54}})));
              ...
              TubeRLC_Derived rightCommonCarotid1(
                ...
                r = 0.37e-2,
                h = 0.063e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-68,68},{-64,72}})));
              ...
              TubeRLC_Derived rightVertebral(
                ...
                r = 0.19e-2,
                h = 0.045e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-80,58},{-76,62}})));
              TubeRLC_Derived rightSubclavian(
                isBranching = true,
                l = 6.8e-2,
                r = 0.4e-2,
                h = 0.066e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-82,56},{-78,60}})));
              ...
              TubeRLC_Derived righInternalMammary(
                ...
                r = 0.1e-2,
                h = 0.03e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-80,54},{-76,58}})));
              TubeRLC_Derived leftCostocervical(
                l = 5e-2,
                isBranching = true,
                r = 0.1e-2,
                h = 0.03e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-42,64},{-38,68}})));
              TubeRLC_Derived leftAxilliary1(
                isBranching = true,
                l = 6.1e-2,
                r = 0.36e-2,
                h = 0.062e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-32,62},{-36,66}})));
              ...
              TubeRLC_Derived leftSuprascapular(
                ...
                r = 0.2e-2,
                h = 0.052e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-42,66},{-38,70}})));
              TubeRLC_Derived leftThyrocervical(
                l = 5e-2,
                isBranching = true,
                r = 0.1e-2,
                h = 0.03e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-42,68},{-38,72}})));
              TubeRLC_Derived leftCommonCarotid3(
                l = 3.1e-2,
                r = 0.37e-2,
                h = 0.063e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-52,70},{-48,74}})));

              TubeRLC_Derived_IABP thoracicAorta2(
                isCannulated = enableECMO and cannulaPlacement == CannulaPlacement. thoracicAorta2,
                l = 5.2e-2,
                r = 0.95e-2,
                h = 0.116e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-60,48},{-56,52}})));

              TubeRLC_Derived rightCommonCarotid2(
                l = 8.9e-2,
                r = 0.37e-2,
                h = 0.063e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-68,70},{-64,74}})));
              ...
              TubeRLC_Derived rightThyrocervical(
                ...
                r = 0.1e-2,
                h = 0.03e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-86,60},{-82,64}})));
              TubeRLC_Derived rightSuprascapular(
                l = 10e-2,
                isBranching = true,
                r = 0.2e-2,
                h = 0.052e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-86,62},{-82,66}})));
              TubeRLC_Derived rightAxilliary1(
                isBranching = true,
                l = 6.1e-2,
                r = 0.36e-2,
                h = 0.062e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-88,56},{-84,60}})));
              ...
              TubeRLC_Derived rightCostocervical(
                ...
                r = 0.1e-2,
                h = 0.03e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-86,58},{-82,62}})));
              TubeRLC_Derived leftThoracoacrominal(
                l = 3e-2,
                isBranching = true,
                r = 0.15e-2,
                h = 0.035e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-38,58},{-34,62}})));
              TubeRLC_Derived leftAxilliary2(
                isBranching = true,
                l = 5.6e-2,
                r = 0.31e-2,
                h = 0.057e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-36,54},{-32,58}})));
              ...
              TubeRLC_Derived leftCircumflexScapular(
                ...
                r = 0.1e-2,
                h = 0.03e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-38,56},{-34,60}})));
              TubeRLC_Derived leftSubscapular(
                l = 8e-2,
                isBranching = true,
                r = 0.15e-2,
                h = 0.035e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-38,60},{-34,64}})));
              TubeRLC_Derived leftInternalCarotid1(
                isBranching = true,
                l = 5.9e-2,
                r = 0.18e-2,
                h = 0.045e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-52,76},{-48,80}})));
              ...
              TubeRLC_Derived leftExternalCarotid(
                ...
                r = 0.15e-2,
                h = 0.042e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-54,74},{-50,78}})));
              ...
              TubeRLC_Derived leftSuperiorThyroid(
                ...
                r = 0.07e-2,
                h = 0.02e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-54,72},{-50,76}})));
              ...
              TubeRLC_Derived rightSuperiorThyroid(
                ...
                r = 0.07e-2,
                h = 0.02e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-70,72},{-66,76}})));
              TubeRLC_Derived rightExternalCarotid(
                isBranching = true,
                l = 11.8e-2,
                r = 0.15e-2,
                h = 0.042e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-70,74},{-66,78}})));
              ...
              TubeRLC_Derived rightInternalCarotid1(
                ...
                r = 0.18e-2,
                h = 0.045e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-68,76},{-64,80}})));
              ...
              TubeRLC_Derived rightSubscapular(
                ...
                r = 0.15e-2,
                h = 0.035e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-94,58},{-90,62}})));
              TubeRLC_Derived rightCircumflexScapular(
                l = 5e-2,
                isBranching = true,
                r = 0.1e-2,
                h = 0.03e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-94,56},{-90,60}})));
              TubeRLC_Derived rightAxilliary2(
                isBranching = true,
                l = 5.6e-2,
                r = 0.31e-2,
                h = 0.057e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-92,52},{-88,56}})));
              ...
              TubeRLC_Derived rightThoracoacrominal(
                ...
                r = 0.15e-2,
                h = 0.035e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-94,54},{-90,58}})));
              TubeRLC_Derived leftBrachial1(
                l = 6.3e-2,
                r = 0.28e-2,
                h = 0.055e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-36,52},{-32,56}})));
              ...
              TubeRLC_Derived leftLingual(
                ...
                r = 0.1e-2,
                h = 0.03e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-54,78},{-50,82}})));
              TubeRLC_Derived leftInternalCarotid2(
                isBranching = true,
                l = 5.9e-2,
                r = 0.13e-2,
                h = 0.039e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-52,82},{-48,86}})));
              ...
              TubeRLC_Derived leftFacial(
                ...
                r = 0.1e-2,
                h = 0.03e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-54,80},{-50,84}})));
              TubeRLC_Derived leftMiddleCerebral(
                l = 3e-2,
                isBranching = true,
                r = 0.06e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-60,72},{-56,76}})));
              TubeRLC_Derived leftCerebral(
                l = 5.9e-2,
                isBranching = true,
                r = 0.08e-2,
                h = 0.026e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-60,74},{-56,78}})));
              TubeRLC_Derived leftOpthalmic(
                l = 3e-2,
                isBranching = true,
                r = 0.07e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-60,76},{-56,80}})));
              TubeRLC_Derived coeliac(
                isBranching = true,
                l = 1e-2,
                r = 0.39e-2,
                h = 0.064e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-64,44},{-60,48}})));
              ...
              TubeRLC_Derived rightOpthalmic(
                ...
                r = 0.07e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-76,72},{-72,76}})));
              TubeRLC_Derived rightCerebral(
                l = 5.9e-2,
                isBranching = true,
                r = 0.08e-2,
                h = 0.026e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-76,74},{-72,78}})));
              TubeRLC_Derived rightMiddleCerebral(
                l = 3e-2,
                isBranching = true,
                r = 0.06e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-76,76},{-72,80}})));
              TubeRLC_Derived rightFacial(
                l = 4e-2,
                r = 0.1e-2,
                h = 0.03e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-70,78},{-66,82}})));
              TubeRLC_Derived rightInternalCarotid2(
                isBranching = true,
                l = 5.9e-2,
                r = 0.13e-2,
                h = 0.039e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-68,82},{-64,86}})));
              ...
              TubeRLC_Derived rightLingual(
                ...
                r = 0.1e-2,
                h = 0.03e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-70,80},{-66,84}})));
              TubeRLC_Derived rightBrachial1(
                isBranching = true,
                l = 6.3e-2,
                r = 0.28e-2,
                h = 0.055e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-94,50},{-90,54}})));
              ...
              TubeRLC_Derived leftProfundaBrachi(
                ...
                r = 0.15e-2,
                h = 0.035e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-38,50},{-34,54}})));
              TubeRLC_Derived leftBrachial2(
                isBranching = true,
                l = 6.3e-2,
                r = 0.26e-2,
                h = 0.053e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-36,48},{-32,52}})));

              TubeRLC_Derived leftInternalCarotid3(
                l = 5.9e-2,
                r = 0.08e-2,
                h = 0.026e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-52,84},{-48,88}})));
              ...
              TubeRLC_Derived gastric1(
                ...
                r = 0.18e-2,
                h = 0.045e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-68,46},{-64,50}})));
              TubeRLC_Derived splenic(
                l = 6.3e-2,
                isBranching = true,
                r = 0.28e-2,
                h = 0.054e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-68,44},{-64,48}})));
              TubeRLC_Derived hepatic(
                l = 6.6e-2,
                isBranching = true,
                r = 0.22e-2,
                h = 0.049e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-68,42},{-64,46}})));
              TubeRLC_Derived renal(
                l = 3.2e-2,
                isBranching = true,
                r = 0.26e-2,
                h = 0.053e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-64,40},{-60,44}})));
              ...
              TubeRLC_Derived superiorMesenteric(
                ...
                r = 0.43e-2,
                h = 0.069e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-64,36},{-60,40}})));
              TubeRLC_Derived gastric2(
                l = 3.2e-2,
                isBranching = true,
                r = 0.26e-2,
                h = 0.053e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-64,38},{-60,42}})));
              TubeRLC_Derived rightInternalCarotid3(
                l = 5.9e-2,
                r = 0.08e-2,
                h = 0.026e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-68,84},{-64,88}})));
              ...
              TubeRLC_Derived rightBrachial2(
                ...
                r = 0.26e-2,
                h = 0.053e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-94,46},{-90,50}})));
              ...
              TubeRLC_Derived rightProfundaBrachi(
                ...
                r = 0.15e-2,
                h = 0.035e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-96,48},{-92,52}})));
              TubeRLC_Derived leftBrachial3(
                isBranching = true,
                l = 6.3e-2,
                r = 0.25e-2,
                h = 0.052e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-36,44},{-32,48}})));
              ...
              TubeRLC_Derived leftSuperiorUlnarCollateral(
                ...
                r = 0.07e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-38,46},{-34,50}})));
              TubeRLC_Derived leftSuperficialTemporal(
                l = 4e-2,
                isBranching = true,
                r = 0.06e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-52,88},{-48,92}})));
              TubeRLC_Derived leftMaxilliary(
                l = 5e-2,
                isBranching = true,
                r = 0.07e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-54,86},{-50,90}})));
              ...
              TubeRLC_Derived rightMaxilliary(
                ...
                r = 0.07e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-70,86},{-66,90}})));
              TubeRLC_Derived rightSuperficialTemporal(
                l = 4e-2,
                isBranching = true,
                r = 0.06e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-68,88},{-64,92}})));
              TubeRLC_Derived rightSuperiorUlnarCollateral(
                l = 5e-2,
                isBranching = true,
                r = 0.07e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-96,44},{-92,48}})));
              TubeRLC_Derived rightBrachial3(
                isBranching = true,
                l = 6.3e-2,
                r = 0.25e-2,
                h = 0.052e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-94,42},{-90,46}})));
              ...
              TubeRLC_Derived leftInferiorUlnarCollateral(
                ...
                r = 0.06e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-38,42},{-34,46}})));
              TubeRLC_Derived leftBrachial4(
                isBranching = true,
                l = 4.6e-2,
                r = 0.24e-2,
                h = 0.05e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-36,40},{-32,44}})));
              ...
              TubeRLC_Derived leftCommonIlliac(
                ...
                r = 0.52e-2,
                h = 0.076e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-54,26},{-50,30}})));
              ...
              TubeRLC_Derived inferiorMesenteric(
                ...
                r = 0.16e-2,
                h = 0.043e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-60,26},{-56,30}})));
              TubeRLC_Derived rightCommonIlliac(
                isBranching = true,
                l = 5.8e-2,
                r = 0.52e-2,
                h = 0.076e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-64,26},{-60,30}})));
              ...
              TubeRLC_Derived rightBrachial4(
                ...
                r = 0.24e-2,
                h = 0.05e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-94,38},{-90,42}})));
              ...
              TubeRLC_Derived rightInferiorUlnarCollateral(
                ...
                r = 0.06e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-96,40},{-92,44}})));
              TubeRLC_Derived leftUlnar1(
                isBranching = true,
                l = 6.7e-2,
                r = 0.21e-2,
                h = 0.049e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-34,38},{-30,42}})));
              ...
              TubeRLC_Derived leftRadial1(
                ...
                r = 0.16e-2,
                h = 0.043e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-40,38},{-36,42}})));
              ...
              TubeRLC_Derived leftExternalIlliac1(
                ...
                r = 0.29e-2,
                h = 0.055e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-54,22},{-50,26}})));
              ...
              TubeRLC_Derived leftInternalIlliac(
                ...
                r = 0.2e-2,
                h = 0.04e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-56,24},{-52,28}})));
              TubeRLC_Derived rightInternalIlliac(
                l = 5e-2,
                isBranching = true,
                r = 0.2e-2,
                h = 0.04e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-66,24},{-62,28}})));
              TubeRLC_Derived rightExternalIlliac1(
                isBranching = true,
                l = 8.3e-2,
                r = 0.29e-2,
                h = 0.055e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-64,22},{-60,26}})));
              ...
              TubeRLC_Derived rightRadial1(
                ...
                r = 0.16e-2,
                h = 0.043e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-96,36},{-92,40}})));
              ...
              TubeRLC_Derived rightUlnar1(
                ...
                r = 0.21e-2,
                h = 0.049e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-92,34},{-88,38}})));
              TubeRLC_Derived leftUlnar2(
                isBranching = true,
                l = 8.5e-2,
                r = 0.19e-2,
                h = 0.046e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-34,34},{-30,38}})));
              ...
              TubeRLC_Derived leftInterossea(
                ...
                r = 0.09e-2,
                h = 0.028e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-36,36},{-32,40}})));
              TubeRLC_Derived leftRadial2(
                l = 11.7e-2,
                r = 0.16e-2,
                h = 0.043e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-42,36},{-38,40}})));
              TubeRLC_Derived leftExternalIlliac2(
                l = 6.1e-2,
                r = 0.27e-2,
                h = 0.053e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-54,20},{-50,24}})));

              TubeRLC_Derived rightExternalIlliac2(
                l = 6.1e-2,
                r = 0.27e-2,
                h = 0.053e-2,
                E = 4e5) annotation (Placement(transformation(extent={{-64,20},{-60,24}})));

              TubeRLC_Derived rightRadial2(
                l = 11.7e-2,
                r = 0.16e-2,
                h = 0.043e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-98,34},{-94,38}})));
              TubeRLC_Derived rightInterossea(
                l = 7.9e-2,
                isBranching = true,
                r = 0.09e-2,
                h = 0.028e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-94,32},{-90,36}})));
              TubeRLC_Derived rightUlnar2(
                l = 8.5e-2,
                isBranching = true,
                r = 0.19e-2,
                h = 0.046e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-92,30},{-88,34}})));

              TubeRLC_Derived leftUlnar3(
                l = 8.5e-2,
                r = 0.19e-2,
                h = 0.046e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-34,32},{-30,36}})));
              TubeRLC_Derived leftFemoral1(
                isBranching = true,
                l = 12.7e-2,
                r = 0.24e-2,
                h = 0.05e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-54,16},{-50,20}})));
              ...
              TubeRLC_Derived leftProfundis(
                ...
                r = 0.23e-2,
                h = 0.049e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-56,18},{-52,22}})));
              TubeRLC_Derived rightProfundis(
                l = 12.6e-2,
                isBranching = true,
                r = 0.23e-2,
                h = 0.049e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-66,18},{-62,22}})));
              TubeRLC_Derived rightFemoral1(
                isBranching = true,
                l = 12.7e-2,
                r = 0.24e-2,
                h = 0.05e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-64,16},{-60,20}})));

              TubeRLC_Derived rightUlnar3(
                l = 8.5e-2,
                r = 0.19e-2,
                h = 0.046e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-92,28},{-88,32}})));
              TubeRLC_Derived leftFemoral2(
                l = 12.7e-2,
                r = 0.24e-2,
                h = 0.05e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-54,14},{-50,18}})));

              TubeRLC_Derived rightFemoral2(
                l = 12.7e-2,
                r = 0.24e-2,
                h = 0.05e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-64,14},{-60,18}})));

              TubeRLC_Derived leftPopliteal1(
                l = 9.4e-2,
                r = 0.2e-2,
                h = 0.047e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-54,12},{-50,16}})));

              TubeRLC_Derived rightPopliteal1(
                l = 9.4e-2,
                r = 0.2e-2,
                h = 0.047e-2,
                E = 8e5) annotation (Placement(transformation(extent={{-64,12},{-60,16}})));
              ...
              TubeRLC_Derived leftAnteriorTibial1(
                ...
                r = 0.13e-2,
                h = 0.039e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-52,2},{-48,6}})));
              ...
              TubeRLC_Derived leftPosteriorTibial1(
                ...
                r = 0.18e-2,
                h = 0.045e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-58,6},{-54,10}})));
              ...
              TubeRLC_Derived rightPosteriorTibial1(
                ...
                r = 0.18e-2,
                h = 0.045e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-64,-2},{-60,2}})));
              ...
              TubeRLC_Derived rightAnteriorTibial1(
                ...
                r = 0.13e-2,
                h = 0.039e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-68,4},{-64,8}})));
              ...
              TubeRLC_Derived leftAnteriorTibial2(
                ...
                r = 0.1e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-52,-4},{-48,0}})));
              ...
              TubeRLC_Derived leftPeroneal1(
                ...
                r = 0.13e-2,
                h = 0.039e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-56,-2},{-52,2}})));

              TubeRLC_Derived leftPosteriorTibial2(
                l = 16.1e-2,
                r = 0.18e-2,
                h = 0.045e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-60,2},{-56,6}})));
              TubeRLC_Derived rightPosteriorTibial2(
                l = 16.1e-2,
                r = 0.18e-2,
                h = 0.045e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-68,-4},{-64,0}})));
              TubeRLC_Derived rightPeroneal1(
                isBranching = true,
                l = 15.9e-2,
                r = 0.13e-2,
                h = 0.039e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-70,-2},{-66,2}})));
              ...
              TubeRLC_Derived rightAnteriorTibial2(
                ...
                r = 0.1e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-72,2},{-68,6}})));

              TubeRLC_Derived leftAnteriorTibial3(
                l = 15e-2,
                r = 0.1e-2,
                h = 0.02e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-52,-8},{-48,-4}})));
              TubeRLC_Derived leftPeroneal2(
                l = 15.9e-2,
                r = 0.13e-2,
                h = 0.019e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-58,-8},{-54,-4}})));
              TubeRLC_Derived rightPeroneal2(
                l = 15.9e-2,
                r = 0.13e-2,
                h = 0.019e-2,
                E = 16e5) annotation (Placement(transformation(extent={{-74,-6},{-70,-2}})));
            ...
            equation
              ...
              connect(rightAnteriorTibial2. cOut, rightAnteriorTibial3. cIn) annotation (Line(
              ...
              connect(leftPeroneal1. cOut, leftPeroneal2. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftAnteriorTibial2. cOut, leftAnteriorTibial3. cIn) annotation (Line(
                  points={{-48.4,-2},{-50,-2},{-50,-6},{-51.6,-6}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightAnteriorTibial1. cOut, rightAnteriorTibial2. cIn) annotation (Line(
                  points={{-64.4,6},{-71.6,6},{-71.6,4}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightAnteriorTibial1. cOut, rightPeroneal1. cIn) annotation (Line(
                  points={{-64.4,6},{-69.6,6},{-69.6,0}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightPosteriorTibial1. cOut, rightPosteriorTibial2. cIn) annotation (Line(
                  points={{-60.4,0},{-67.6,0},{-67.6,-2}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftPosteriorTibial1. cOut, leftPosteriorTibial2. cIn) annotation (Line(
                  points={{-54.4,8},{-59.6,8},{-59.6,4}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftAnteriorTibial1. cOut, leftPeroneal1. cIn) annotation (Line(
                  points={{-48.4,4},{-55.6,4},{-55.6,0}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftAnteriorTibial1. cOut, leftAnteriorTibial2. cIn) annotation (Line(
                  points={{-48.4,4},{-50,4},{-50,-2},{-51.6,-2}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightPopliteal2. cOut, rightAnteriorTibial1. cIn) annotation (Line(
                  points={{-62,11.6},{-67.6,11.6},{-67.6,6}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightPopliteal2. cOut, rightPosteriorTibial1. cIn) annotation (Line(
                  points={{-62,11.6},{-62,0},{-63.6,0}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftPopliteal2. cOut, leftPosteriorTibial1. cIn) annotation (Line(
                  points={{-52,11.6},{-54,11.6},{-54,8},{-57.6,8}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftPopliteal2. cOut, leftAnteriorTibial1. cIn) annotation (Line(
                  points={{-52,11.6},{-50,11.6},{-50,4},{-51.6,4}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightPopliteal1. cOut, rightPopliteal2. cIn) annotation (Line(
              ...
              connect(rightUlnar2. cOut, rightUlnar3. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightExternalIlliac2. cOut, rightFemoral1. cIn) annotation (Line(
                  points={{-60.4,22},{-62,22},{-62,18},{-63.6,18}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightExternalIlliac2. cOut, rightProfundis. cIn) annotation (Line(
                  points={{-60.4,22},{-65.6,22},{-65.6,20}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftExternalIlliac2. cOut, leftProfundis. cIn) annotation (Line(
                  points={{-50.4,22},{-55.6,22},{-55.6,20}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftExternalIlliac2. cOut, leftFemoral1. cIn) annotation (Line(
              ...
              connect(rightRadial1. cOut, rightRadial2. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightExternalIlliac1. cOut, rightExternalIlliac2. cIn) annotation (Line(
                  points={{-60.4,24},{-62,24},{-62,22},{-63.6,22}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftExternalIlliac1. cOut, leftExternalIlliac2. cIn) annotation (Line(
              ...
              connect(rightBrachial4. cOut, rightUlnar1. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightCommonIlliac. cOut, rightInternalIlliac. cIn) annotation (Line(
                  points={{-60.4,28},{-65.6,28},{-65.6,26}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightCommonIlliac. cOut, rightExternalIlliac1. cIn) annotation (Line(
                  points={{-60.4,28},{-62,28},{-62,24},{-63.6,24}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCommonIlliac. cOut, leftInternalIlliac. cIn) annotation (Line(
                  points={{-50.4,28},{-55.6,28},{-55.6,26}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCommonIlliac. cOut, leftExternalIlliac1. cIn) annotation (Line(
              ...
              connect(leftBrachial4. cOut, leftUlnar1. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightBrachial3. cOut, rightInferiorUlnarCollateral. cIn) annotation (Line(
              ...
              connect(rightBrachial4. cIn, rightBrachial3. cOut) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightCommonIlliac. cIn, abdominalAorta3. cOut) annotation (Line(
                  points={{-63.6,28},{-60,28},{-60,33.6},{-58,33.6}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(inferiorMesenteric. cIn, abdominalAorta3. cOut) annotation (Line(
                  points={{-59.6,28},{-58,28},{-58,33.6}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCommonIlliac. cIn, abdominalAorta3. cOut) annotation (Line(points={{-53.6,28},{-54,28},{-54,30},
                      {-58,30},{-58,33.6}},     smooth=Smooth.None));
              connect(leftBrachial4. cIn, leftBrachial3. cOut) annotation (Line(
                  points={{-35.6,42},{-34,42},{-34,46},{-32.4,46}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftBrachial3. cOut, leftInferiorUlnarCollateral. cIn) annotation (Line(
                  points={{-32.4,46},{-37.6,46},{-37.6,44}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightSuperiorUlnarCollateral. cIn, rightBrachial2. cOut) annotation (Line(
              ...
              connect(rightBrachial2. cOut, rightBrachial3. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightInternalCarotid3. cOut, rightMaxilliary. cIn) annotation (Line(
                  points={{-64.4,86},{-69.6,86},{-69.6,88}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightInternalCarotid3. cOut, rightSuperficialTemporal. cIn) annotation (Line(
                  points={{-64.4,86},{-66,86},{-66,90},{-67.6,90}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(abdominalAorta2. cOut, abdominalAorta3. cIn) annotation (Line(
                  points={{-58,37.6},{-58,30.4}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftInternalCarotid3. cOut, leftMaxilliary. cIn) annotation (Line(
                  points={{-48.4,86},{-53.6,86},{-53.6,88}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftInternalCarotid3. cOut, leftSuperficialTemporal. cIn) annotation (Line(
                  points={{-48.4,86},{-50,86},{-50,90},{-51.6,90}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftBrachial2. cOut, leftSuperiorUlnarCollateral. cIn) annotation (Line(
              ...
              connect(leftBrachial2. cOut, leftBrachial3. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightInternalCarotid3. cIn, rightInternalCarotid2. cOut) annotation (Line(
                  points={{-67.6,86},{-66,86},{-66,84},{-64.4,84}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightBrachial1. cOut, rightProfundaBrachi. cIn) annotation (Line(
              ...
              connect(abdominalAorta1. cOut, abdominalAorta2. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(abdominalAorta1. cOut, superiorMesenteric. cIn) annotation (Line(
              ...
              connect(coeliac. cOut, hepatic. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftInternalCarotid2. cOut, leftInternalCarotid3. cIn) annotation (Line(
                  points={{-48.4,84},{-50,84},{-50,86},{-51.6,86}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftBrachial1. cOut, leftProfundaBrachi. cIn) annotation (Line(
              ...
              connect(leftBrachial1. cOut, leftBrachial2. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightAxilliary2. cOut, rightBrachial1. cIn) annotation (Line(
                  points={{-88.4,54},{-93.6,54},{-93.6,52}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightInternalCarotid1. cOut, rightFacial. cIn) annotation (Line(
                  points={{-64.4,78},{-69.6,78},{-69.6,80}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightInternalCarotid1. cOut, rightLingual. cIn) annotation (Line(
                  points={{-64.4,78},{-69.6,78},{-69.6,82}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightInternalCarotid1. cOut, rightInternalCarotid2. cIn) annotation (Line(
                  points={{-64.4,78},{-66,78},{-66,84},{-67.6,84}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightCerebral. cIn, rightExternalCarotid. cOut) annotation (Line(
                  points={{-75.6,76},{-66.4,76}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightExternalCarotid. cOut, rightOpthalmic. cIn) annotation (Line(
                  points={{-66.4,76},{-70,76},{-70,74},{-75.6,74}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightExternalCarotid. cOut, rightMiddleCerebral. cIn) annotation (Line(
              ...
              connect(thoracicAorta3. cOut, coeliac. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftInternalCarotid1. cOut, leftLingual. cIn) annotation (Line(
                  points={{-48.4,78},{-53.6,78},{-53.6,80}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftInternalCarotid1. cOut, leftFacial. cIn) annotation (Line(
                  points={{-48.4,78},{-53.6,78},{-53.6,82}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftInternalCarotid1. cOut, leftInternalCarotid2. cIn) annotation (Line(
                  points={{-48.4,78},{-50,78},{-50,84},{-51.6,84}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCerebral. cIn, leftExternalCarotid. cOut) annotation (Line(
                  points={{-59.6,76},{-50.4,76}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftExternalCarotid. cOut, leftMiddleCerebral. cIn) annotation (Line(
                  points={{-50.4,76},{-54,76},{-54,74},{-59.6,74}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftExternalCarotid. cOut, leftOpthalmic. cIn) annotation (Line(
              ...
              connect(leftAxilliary2. cOut, leftBrachial1. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightAxilliary1. cOut, rightCircumflexScapular. cIn) annotation (Line(
                  points={{-84.4,58},{-93.6,58}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightAxilliary1. cOut, rightThoracoacrominal. cIn) annotation (Line(
                  points={{-84.4,58},{-88,58},{-88,56},{-93.6,56}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightAxilliary1. cOut, rightSubscapular. cIn) annotation (Line(
                  points={{-84.4,58},{-88,58},{-88,60},{-93.6,60}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightAxilliary1. cOut, rightAxilliary2. cIn) annotation (Line(
                  points={{-84.4,58},{-91.6,58},{-91.6,54}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightCommonCarotid2. cOut, rightSuperiorThyroid. cIn) annotation (Line(
                  points={{-64.4,72},{-69.6,72},{-69.6,74}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightCommonCarotid2. cOut, rightExternalCarotid. cIn) annotation (Line(
                  points={{-64.4,72},{-69.6,72},{-69.6,76}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightCommonCarotid2. cOut, rightInternalCarotid1. cIn) annotation (Line(
              ...
              connect(thoracicAorta2. cOut, thoracicAorta3. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCommonCarotid3. cOut, leftSuperiorThyroid. cIn) annotation (Line(
                  points={{-48.4,72},{-53.6,72},{-53.6,74}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCommonCarotid3. cOut, leftExternalCarotid. cIn) annotation (Line(
                  points={{-48.4,72},{-53.6,72},{-53.6,76}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCommonCarotid3. cOut, leftInternalCarotid1. cIn) annotation (Line(
                  points={{-48.4,72},{-50,72},{-50,78},{-51.6,78}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftAxilliary1. cOut, leftSubscapular. cIn) annotation (Line(
                  points={{-35.6,64},{-35.6,62},{-37.6,62}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftAxilliary1. cOut, leftThoracoacrominal. cIn) annotation (Line(
                  points={{-35.6,64},{-37.6,64},{-37.6,60}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftAxilliary1. cOut, leftCircumflexScapular. cIn) annotation (Line(
              ...
              connect(leftAxilliary1. cOut, leftAxilliary2. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightSubclavian. cOut, rightAxilliary1. cIn) annotation (Line(
                  points={{-78.4,58},{-87.6,58}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightSubclavian. cOut, rightCostocervical. cIn) annotation (Line(
                  points={{-78.4,58},{-85.6,58},{-85.6,60}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightSubclavian. cOut, rightThyrocervical. cIn) annotation (Line(
                  points={{-78.4,58},{-85.6,58},{-85.6,62}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightSubclavian. cOut, rightSuprascapular. cIn) annotation (Line(
                  points={{-78.4,58},{-85.6,58},{-85.6,64}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightCommonCarotid2. cIn, rightCommonCarotid1. cOut) annotation (Line(
              ...
              connect(thoracicAorta1. cOut, thoracicAorta2. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCommonCarotid2. cOut, leftCommonCarotid3. cIn) annotation (Line(
                  points={{-48.4,70},{-50,70},{-50,72},{-51.6,72}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftSubclavian2. cOut, leftAxilliary1. cIn) annotation (Line(
                  points={{-45.6,64},{-32.4,64}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftSubclavian2. cOut, leftCostocervical. cIn) annotation (Line(
                  points={{-45.6,64},{-41.6,64},{-41.6,66}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftSubclavian2. cOut, leftSuprascapular. cIn) annotation (Line(
                  points={{-45.6,64},{-41.6,64},{-41.6,68}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftSubclavian2. cOut, leftThyrocervical. cIn) annotation (Line(
              ...
              connect(aorticArch2. cOut, thoracicAorta1. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftCommonCarotid1. cOut, leftCommonCarotid2. cIn) annotation (Line(
                  points={{-48.4,68},{-50,68},{-50,70},{-51.6,70}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftSubclavian1. cOut, leftSubclavian2. cIn) annotation (Line(
                  points={{-55.6,62},{-50,62},{-50,64},{-42.4,64}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftSubclavian1. cOut, leftInternalMammary. cIn) annotation (Line(
              ...
              connect(leftSubclavian1. cOut, leftVertebral. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(brachiocephalic. cOut, rightVertebral. cIn) annotation (Line(
                  points={{-60.4,62},{-70,62},{-70,60},{-79.6,60}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(brachiocephalic. cOut, rightSubclavian. cIn) annotation (Line(
                  points={{-60.4,62},{-70,62},{-70,58},{-81.6,58}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(brachiocephalic. cOut, righInternalMammary. cIn) annotation (Line(
                  points={{-60.4,62},{-70,62},{-70,56},{-79.6,56}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(brachiocephalic. cOut, rightCommonCarotid1. cIn) annotation (Line(
              ...
              connect(aorticArch1. cOut, brachiocephalic. cIn) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(aorticArch1. cOut, leftCommonCarotid1. cIn) annotation (Line(
              ...
              connect(leftAnteriorTibial3. cOut, cOut) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftPosteriorTibial2. cOut, cOut) annotation (Line(points={{-56.4,4},{-72,4},{-72,0},{80,
                      0}},     smooth=Smooth.None));
              ...
              connect(rightCostocervical. cOut, cOut) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(rightThyrocervical. cOut, cOut) annotation (Line(points={{-82.4,62},{-86,62},{-86,0},{
              ...
              connect(leftThyrocervical. cOut, cOut) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(righInternalMammary. cOut, cOut) annotation (Line(points={{-76.4,56},{-82,56},{-82,6},{
                      -86,6},{-86,0},{80,0}},   smooth=Smooth.None));
              connect(rightVertebral. cOut, cOut) annotation (Line(
                  points={{-76.4,60},{-82,60},{-82,0},{80,0}},
                  color={0,0,0},
                  smooth=Smooth.None));
              connect(leftVertebral. cOut, cOut) annotation (Line(points={{-44.4,58},{-64,58},{-64,12},{
                      -82,12},{-82,6},{-86,6},{-86,0},{80,0}},   smooth=Smooth.None));
              connect(leftInternalMammary. cOut, cOut) annotation (Line(points={{-44.4,60},{-64,60},{-64,10},{
                      -82,10},{-82,6},{-86,6},{-86,0},{80,0}},   smooth=Smooth.None));
          ...
          package ECMO "ECMO device and its components"
            ...
            protected
              ...
              Time tPeak = pulseDuration / 2
                "Time of peak of the parabolic pulse";
              Real scale "Parabola scaling coefficient";

            public
              Pump ecmoPump(qRef = qRef) if _isEnabled
                annotation (Placement(transformation(extent={{-44,-16},{-8,16}})));
              ...
              TubeR middleTube(
                l = 0.2,
                r = 0.005) if _isEnabled
                annotation (Placement(transformation(extent={{-10,-10},{42,12}})));
              TubeR outflowTube(
                l = 0.5,
                r = 0.005) if _isEnabled
                annotation (Placement(transformation(
              ...
              TubeR venousCannula(
                l = settings. supports. ECMO_cannulaLength,
                r = settings. supports. ECMO_cannulaInnerDiameter / 2) if _isEnabled
                annotation (Placement(transformation(
                    extent={{-6.23204,-6.86599},{6.23204,6.86599}},
                    rotation=60,
                    origin={-65.1699,35.1699})));
              TubeR arterialCannula(
                l = settings. supports. ECMO_cannulaLength,
                r = settings. supports. ECMO_cannulaInnerDiameter / 2) if _isEnabled
                annotation (Placement(transformation(
            ...
            equation
              ...
              elseif pulseShapeRef == PulseShape. square then
                qRef = if t >= 0 and t <= pulseDuration then qMeanRef * cycleDuration / pulseDuration else 0;
              ...
              annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
                                           graphics), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(extent={{-88,-128},{86,46}},
                      fileName="modelica://Cardio/../../../../../../ECMO.png")}));
            end ECMO;
            ...
            equation
              cIn. q = -cOut. q;
              dp = -p;
              der(p) = (qRef - cIn. q) * settings. constants. ecmoPumpPressureAdaptationRate;

              annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                        -100},{100,100}}), graphics), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(extent={{-80,-79},{80,79}},
                      fileName="modelica://Cardio/../../../../../Physiolibrary-master/Physiolibrary-master/Physiolibrary/Resources/Icons/vrtule.png",
                      origin={8,19},
                      rotation=140)}));
            end Pump;
            ...
            model Oxygenator "Resistive hollow-fiber oxygenator"
              ...
              Elements.R resistor(R = 8 * mu * fiberLength / pi / (0.5 * fiberDiameter) ^ 4 / fiberCount)
            ...
            equation
              ...
              annotation (Diagram(graphics), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(
                      extent={{81.7687,77.1199},{-81.7687,-77.1199}},
                      fileName="modelica://Cardio/../../../../../../Capillaries.png",
                      origin={-0.4103,-2.5352},
                      rotation=181), Bitmap(extent={{-58,-90},{40,8}},
                      fileName="modelica://Cardio/../../../../../../O2.png")}));
            end Oxygenator;
          end ECMO;
        end Main;
      ...
      model Cardio "The complete model"
...
My Arteries"),Line(
          ...
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
              graphics={
              Bitmap(extent={{-64,-76},{64,60}},
                fileName="modelica://Cardio/../../../../../../package_favorite.png"),
              Bitmap(extent={{-24,-28},{24,24}},
  ...
  package Types
    package Constants
      block FrequencyControl "External signal of type Frequency"
        Physiolibrary.Blocks.Types.RealIO.FrequencyOutput y
          "HydraulicCompliance constant" annotation (Placement(transformation(
                extent={{40,-10},{60,10}}), iconTransformation(extent={{40,-10},
                  {60,10}})));
        Physiolibrary.Blocks.Types.RealIO.FrequencyInput c annotation (
            Placement(transformation(extent={{-40,-20},{0,20}}),
              iconTransformation(extent={{-40,-20},{0,20}})));
        parameter Physiolibrary.Blocks.Types.Frequency k;
  ...
  package Icons
    class Arteries
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/Arteries.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
    end Arteries;

    class Atrium
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/Atrium.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
    end Atrium;
    ...
    class Cardio
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName=
                  "modelica://Cardiovascular/Resources/Icons/Cardio.png"),
              Bitmap(extent={{-50,-38},{52,62}}, fileName=
                  "modelica://Cardiovascular/Resources/Icons/Cross.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
    end Cardio;

    class ECMO
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/ECMO.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
    end ECMO;

    class Heart_detailed
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/Heart_detailed.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
    end Heart_detailed;

    class O2
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/O2.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
    end O2;

    class Screw
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/Screw.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
    end Screw;

    class Settings
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/Settings.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
    end Settings;

      class Valve
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/Valve.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
      end Valve;

      class Ventricle
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/Ventricle.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
      end Ventricle;

      class Vessels
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://Cardiovascular/Resources/Icons/Vessels.png")}),
          Diagram(coordinateSystem(preserveAspectRatio=false)));
      end Vessels;
