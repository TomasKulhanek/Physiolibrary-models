  ...
  package Test "Test components and models used during  development."
    ...
    equation
      ...
      connect(cardioPulmonarySoluteInFlow.port_out, soluteElimination.port_in)
        annotation (Line(
          points={{8,59.8},{26,59.8},{26,26},{8,26}},
          color={107,45,134},
          thickness=1,
          smooth=Smooth.None));
    ...
    equation
      ...
      connect(add1.y, tube.SolventFlowRate) annotation (Line(
          points={{-47,12},{-44,12},{-44,10.6},{-44.2,10.6}},
          color={0,0,127},
          smooth=Smooth.None));
    ...
    equation
      ...
      connect(cardioPulmonarySoluteInFlow.port_out, nonMuscleElimination.port_in)
        annotation (Line(
          points={{70,51.8},{82,51.8},{82,26},{74,26}},
          color={107,45,134},
          thickness=1,
          smooth=Smooth.None));
    ...
    equation
      ...
      connect(mixing.port_b, cardioPulmonarySoluteInFlow.port_in) annotation (
          Line(
          points={{33.8,45.8},{33.8,52},{50,52}},
          color={107,45,134},
          thickness=1,
          smooth=Smooth.None));
...
")}),                Diagram(coordinateSystem(preserveAspectRatio=false, extent=
  ...
  package ModelWithStreamConnector
    connector GasesInPlasmaFlow
      ...
      stream Physiolibrary.Types.Concentration o2;
      stream Physiolibrary.Types.Concentration co2;
    end GasesInPlasmaFlow;

    model HeartAndLungs "simulates flow and oxygenation in lungs"
      extends Physiolibrary.Icons.PulmonaryCirculation;

      GPInflow g_in annotation (Placement(transformation(extent={{-110,-10},{-90,
                10}}), iconTransformation(extent={{-110,-10},{-90,10}})));
      GPOutflow g_out annotation (Placement(transformation(extent={{90,-12},{110,
                8}}), iconTransformation(extent={{90,-12},{110,8}})));
      Physiolibrary.Types.RealIO.VolumeFlowRateInput flowrate annotation (Placement(
            transformation(extent={{-58,46},{-18,86}}), iconTransformation(
            extent={{-20,-20},{20,20}},
            rotation=270,
            origin={-60,80})));
      Physiolibrary.Types.RealIO.ConcentrationInput o2c
        "prescribed o2 concentration outgoing from pulmonary circulation"                                                 annotation (Placement(
            transformation(extent={{2,58},{42,98}}), iconTransformation(
            extent={{-20,-20},{20,20}},
            rotation=270,
            origin={20,80})));
      Physiolibrary.Types.RealIO.ConcentrationInput co2c
        "prescribed co2 concentration outgoing from pulmonary circulation"                                                  annotation (Placement(
            transformation(extent={{76,60},{116,100}}), iconTransformation(
            extent={{-20,-20},{20,20}},
            rotation=270,
            origin={80,80})));
    equation
    ...
    model CirculationWithoutConc
      ...
      Physiolibrary.Hydraulic.Components.Conductor muscle(Conductance(
        ...
        annotation (Placement(transformation(extent={{8,-32},{-10,-14}})));
      Physiolibrary.Hydraulic.Components.ElasticVessel veins(
        volume_start=0.001975,
        ZeroPressureVolume=0.001,
        Compliance=7.5006157584566e-08)
        annotation (Placement(transformation(extent={{-44,18},{-24,38}})));
      Physiolibrary.Hydraulic.Components.Pump pump
        annotation (Placement(transformation(extent={{-6,46},{14,66}})));
    equation
      connect(arteries.q_in, nonmuscle.q_in) annotation (Line(
          points={{36,30},{36,4},{10,4}},
          color={0,0,0},
          thickness=1,
          smooth=Smooth.None));
      connect(muscle.q_in, nonmuscle.q_in) annotation (Line(
          points={{8,-23},{22,-23},{22,-22},{36,-22},{36,4},{10,4}},
          color={0,0,0},
          thickness=1,
          smooth=Smooth.None));
      connect(muscle.q_out, veins.q_in) annotation (Line(
          points={{-10,-23},{-20,-23},{-20,-24},{-34,-24},{-34,28}},
          color={0,0,0},
          thickness=1,
          smooth=Smooth.None));
      connect(nonmuscle.q_out, veins.q_in) annotation (Line(
          points={{-10,4},{-34,4},{-34,28}},
          color={0,0,0},
          thickness=1,
          smooth=Smooth.None));
      connect(veins.q_in, pump.q_in) annotation (Line(
          points={{-34,28},{-32,28},{-32,56},{-6,56}},
          color={0,0,0},
          thickness=1,
          smooth=Smooth.None));
      connect(pump.q_out, arteries.q_in) annotation (Line(
          points={{14,56},{36,56},{36,30}},
          color={0,0,0},
          thickness=1,
          smooth=Smooth.None));
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{
                -100,-100},{100,100}}), graphics));
    end CirculationWithoutConc;

    partial model Pump "Prescribed volumetric flow"
      extends OnePort;
      extends Physiolibrary.Chemical.Interfaces.ConditionalSolutionFlow;
      Physiolibrary.Types.RealIO.ConcentrationInput o2c
        "prescribed o2 concentration outgoing from pulmonary circulation"                                                 annotation (Placement(
            transformation(extent={{18,38},{58,78}}),iconTransformation(
            extent={{-20,-20},{20,20}},
            rotation=270,
            origin={60,80})));
      Physiolibrary.Types.RealIO.ConcentrationInput co2c
    ...
    equation
      volumeFlowRate = q;
      q_out.o2 = o2c; //prescribed o2 concentration outgoing from pulmonary circ.
      q_out.co2 = co2c; //prescribed co2 concentration outgoing from pulmonary circ.
     ...
     annotation (
        Icon(coordinateSystem(preserveAspectRatio=false,extent={{-100,-100},{100,100}}),
            ...
            Text(
              ...
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid,
              textString="CO2")}),           Documentation(revisions="<html>
<table>
<tr>
<td>Author:</td>
<td>Marek Matejak</td>
...
<p><font style=\"font-size: 9pt; \">This element needs to be connected only to next hydraulic elements, which contain calculation of hydraulic pressure in connector. It is because equation contains only </font><b><font style=\"font-size: 9pt; \">hydraulic volume flow</font></b><font style=\"font-size: 9pt; \"> variable, which is set to value of input signal variable. </font></p>
    ...
    partial model OnePort "Hydraulical OnePort"
      ...
      GPInflow q_in "Volume inflow"
        annotation (Placement(transformation(extent={{-114,-14},{-86,14}})));
      GPOutflow q_out "Volume outflow"
       ...
       Physiolibrary.Types.Concentration do2 "concentration gradient o2";
       Physiolibrary.Types.Concentration dco2 "concentration gradient o2";
    equation
      q_in.q + q_out.q = 0;
      volumeFlowRate = q_in.q;
      dp = q_in.pressure - q_out.pressure;
      do2 = q_in.o2 - q_out.o2;
      dco2 = q_in.co2 - q_out.co2;
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                -100},{100,100}}), graphics), Icon(coordinateSystem(
              preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics));
    end OnePort;
...
<p><font style=\"font-size: 9pt; \">This element needs to be connected only to next hydraulic elements, which contain calculation of hydraulic pressure in connector. It is because equation contains only </font><b><font style=\"font-size: 9pt; \">hydraulic volume flow</font></b><font style=\"font-size: 9pt; \"> variable, which is set to value of input signal variable. </font></p>
    ...
    partial model UnlimitedOutflowPump "Prescribed flow at port"
      extends Physiolibrary.Chemical.Interfaces.ConditionalSolutionFlow;
      GPInflow q_in annotation (Placement(transformation(extent={{-114,-14},{-86,14}}),
...
<p><font style=\"font-size: 9pt; \">This element needs to be connected only to next hydraulic elements, which contain calculation of hydraulic pressure in connector. It is because equation contains only </font><b><font style=\"font-size: 9pt; \">hydraulic volume flow</font></b><font style=\"font-size: 9pt; \"> variable, which is set to value of input signal variable. </font></p>
    ...
    equation
      ...
      connect(nonmuscle.q_out, veins.q_in) annotation (Line(
          ...
          thickness=1,
          smooth=Smooth.None));
      connect(veins.q_in, unlimitedOutflowPump.q_in) annotation (Line(
          points={{-34,28},{-34,56},{-20,56}},
          color={0,0,0},
          thickness=1,
          smooth=Smooth.None));
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{
                -100,-100},{100,100}}), graphics));
    end CirculationWithoutConc2;
    ...
    equation
      ...
      der(do2) = o2rate;//max(0,q_in.o2-o2rate);
      q_out.co2 = 1;//q_in.co2+(q_out.o2-q_in.o2);
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{
                -100,-100},{100,100}}),
                       graphics={Text(
