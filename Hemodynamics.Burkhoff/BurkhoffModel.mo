...
package BurkhoffModel
  ...
  package Parts
    model Hemodynamics "model of hemodynamics by Burkhoff in Physiolibrary"
      ...
      PulmonaryCirculation pulmonaryCirculation annotation(Placement(transformation(extent = {{-26,58},{18,110}})));
      PressureFlowMeasurement MeasurementPumlonaryArtery annotation(Placement(transformation(origin = {-29.5,51.5}, extent = {{-13.5,-17.5},{13.5,17.5}}, rotation = 90)));
      PressureFlowMeasurement MeasurementPulmonaryVein annotation(Placement(transformation(origin = {15.5,51.5}, extent = {{-15.5,-18.5},{15.5,18.5}}, rotation = 270)));
      SystemicCirculation systemicCirculation annotation(Placement(transformation(extent = {{-46,-94},{4,-54}})));
      PressureFlowMeasurement MeasurementVein annotation(Placement(transformation(origin = {-58.5,-50.5}, extent = {{-15.5,-20.5},{15.5,20.5}}, rotation = 90)));
      PressureFlowMeasurement MeasurementAorta annotation(Placement(transformation(origin = {43.5,-56.5}, extent = {{-15.5,-20.5},{15.5,20.5}}, rotation = 270)));
      HeartElasticities heartElasticities annotation(Placement(transformation(extent = {{-76,10},{-54,30}})));
      BloodVolume bloodVolume annotation(Placement(transformation(extent = {{14,-112},{44,-88}})));
      Physiolibrary.Types.Constants.PressureConst PTH(k = 0) annotation(Placement(transformation(extent = {{-62,36},{-54,44}})));
      GainConst AVGain(k = 0.02) annotation(Placement(transformation(extent = {{-94,-30},{-86,-22}})));
      ...
      RightHeart rightHeart annotation(Placement(visible = true, transformation(origin = {-23,-17}, extent = {{-23,-23},{23,23}}, rotation = 0)));
      LeftHeart leftHeart annotation(Placement(visible = true, transformation(origin = {15,-18}, extent = {{-19,-22},{19,22}}, rotation = 0)));
    equation
      connect(leftHeart.Volume,bloodVolume.LeftHeartBloodVolume) annotation(Line(points = {{16.9,-40},{10,-40},{10,-48},{10,-50},{24.2,-50},{24.2,-88.95999999999999}}, color = {0,0,127}, pattern = LinePattern.Dot, smooth = Smooth.Bezier));
      connect(leftHeart.StressedVolume,bloodVolume.LeftHeartStressedVolume) annotation(Line(points = {{27.54,-40.44},{20.86,-40.44},{27.5,-44},{27.5,-88.95999999999999}}, color = {0,0,127}, pattern = LinePattern.Dot, smooth = Smooth.Bezier));
      connect(AVGain.y,leftHeart.AVGain) annotation(Line(points = {{-85,-26},{24.22,-29.44},{30.58,-29.44}}, color = {0,0,127}, smooth = Smooth.Bezier));
      connect(PTH.y,leftHeart.PTH) annotation(Line(points = {{-53,40},{-40,40},{-40,30},{24.22,0.92},{30.58,0.92}}, color = {0,0,127}, pattern = LinePattern.Dash, smooth = Smooth.Bezier));
      connect(heartElasticities.VEt0,leftHeart.VEt0) annotation(Line(points = {{-54.44,26.6},{14.56,0.92},{21.84,0.92}}, color = {0,0,127}, smooth = Smooth.Bezier));
      connect(heartElasticities.AEt0,leftHeart.AEt0) annotation(Line(points = {{-54.22,22.2},{4.9,0.92},{13.1,0.92}}, color = {0,0,127}, smooth = Smooth.Bezier));
      connect(MeasurementAorta.Inflow,leftHeart.outflow) annotation(Line(points = {{43.91,-41.31},{43.91,18},{-4.34,2.68},{4.74,2.68}}, thickness = 1, smooth = Smooth.Bezier));
      connect(MeasurementPulmonaryVein.Outflow,leftHeart.inflow) annotation(Line(points = {{15.5,36.31},{24,36.31},{24,22},{40,22},{40,-12.4},{11.58,-12.4},{11.58,-14.04}}, thickness = 1, smooth = Smooth.Bezier));
      ...
      connect(AVGain.y,rightHeart.AVGain) annotation(Line(points = {{-85,-26},{-64,-26},{-41.4,-28.02},{-41.4,-31.26}}, color = {0,0,127}, smooth = Smooth.Bezier));
      connect(PTH.y,rightHeart.PTH) annotation(Line(points = {{-53,40},{-40,40},{-40,30},{-26,0.9399999999999999},{-23,0.9399999999999999}}, color = {0,0,127}, pattern = LinePattern.Dash, smooth = Smooth.Bezier));
      connect(heartElasticities.VEt0,rightHeart.VEt0) annotation(Line(points = {{-54.44,26.6},{-34.4,0.9399999999999999},{-32.66,0.9399999999999999}}, color = {0,0,127}, smooth = Smooth.Bezier));
      connect(heartElasticities.AEt0,rightHeart.AEt0) annotation(Line(points = {{-54.22,22.2},{-54.22,22},{-42,22},{-42,12},{-42.32,12},{-42.32,0.9399999999999999}}, color = {0,0,127}, smooth = Smooth.Bezier));
      connect(MeasurementVein.Outflow,rightHeart.port_a) annotation(Line(points = {{-58.5,-35.31},{-58.5,-26},{-58.5,-16.54},{-23.92,-16.54}}, thickness = 1, smooth = Smooth.Bezier));
      connect(rightHeart.port_b,MeasurementPumlonaryArtery.Inflow) annotation(Line(points = {{-12.42,-3.2},{-16.8,-3.2},{-16,4},{-16,10},{-29.85,10},{-29.85,38.27}}, thickness = 1, smooth = Smooth.Bezier));
      connect(MeasurementPumlonaryArtery.Outflow,pulmonaryCirculation.bloodFlowInflow) annotation(Line(points = {{-29.5,64.73},{-29.5,74},{-26,74},{-26,83.48}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(pulmonaryCirculation.bloodFlowOutflow,MeasurementPulmonaryVein.Inflow) annotation(Line(points = {{18,84},{18,66.69},{15.87,66.69}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      ...
      connect(HeartRate.y,MeasurementPumlonaryArtery.HR) annotation(Line(points = {{-85,88},{-62,88},{-62,51.5},{-41.4,51.5}}, color = {0,0,127}, smooth = Smooth.Bezier));
      ...
      connect(HeartRate.y,MeasurementVein.HR) annotation(Line(points = {{-85,88},{-80,88},{-80,-50.5},{-72.44,-50.5}}, color = {0,0,127}, smooth = Smooth.Bezier));
      connect(HeartRate.y,MeasurementPulmonaryVein.HR) annotation(Line(points = {{-85,88},{-58,88},{-58,102},{48,102},{48,51.5},{28.08,51.5}}, color = {0,0,127}, smooth = Smooth.Bezier));
      connect(HeartRate.y,MeasurementAorta.HR) annotation(Line(points = {{-85,88},{-58,88},{-58,102},{50,102},{50,-32},{50,-36},{70,-36},{70,-56.5},{57.44,-56.5}}, color = {0,0,127}, smooth = Smooth.Bezier));
      ...
      connect(systemicCirculation.bloodflowOutflow,MeasurementVein.Inflow) annotation(Line(points = {{-45,-74.40000000000001},{-51.5,-74.40000000000001},{-51.5,-65.69},{-58.91,-65.69}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(systemicCirculation.bloodflowInflow,MeasurementAorta.Outflow) annotation(Line(points = {{3.5,-74.40000000000001},{23.75,-74.40000000000001},{23.75,-71.69},{43.5,-71.69}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
    ...
    model PulmonaryCirculation
      ...
      Physiolibrary.Hydraulic.Components.Conductor conductor(useConductanceInput = true) annotation(Placement(transformation(extent = {{-38,-12},{-18,8}})));
      ...
      Physiolibrary.Hydraulic.Components.Conductor conductor1(useConductanceInput = true) annotation(Placement(transformation(extent = {{10,-12},{30,8}})));
      ...
      Physiolibrary.Hydraulic.Components.Conductor conductor2(useConductanceInput = true) annotation(Placement(transformation(extent = {{64,-10},{84,10}})));
    ...
    equation
      ...
      connect(conductor.cond,RcPulm.y) annotation(Line(points = {{-28,4},{-28,44},{-31,44}}, color = {0,0,127}, smooth = Smooth.None));
      ...
      connect(conductor1.cond,RaPulm.y) annotation(Line(points = {{20,4},{20,40},{19,40}}, color = {0,0,127}, smooth = Smooth.None));
      ...
      connect(PulmonaryArteryProximal.q_in,conductor.q_in) annotation(Line(points = {{-52,22},{-46,22},{-46,-2},{-38,-2}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(conductor.q_out,PulmonaryArtery.q_in) annotation(Line(points = {{-18,-2},{-10,-2},{-10,22},{-2,22}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(PulmonaryArtery.q_in,conductor1.q_in) annotation(Line(points = {{-2,22},{4,22},{4,-2},{10,-2}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(conductor1.q_out,PulmonaryVeins.q_in) annotation(Line(points = {{30,-2},{38,-2},{38,24},{46,24}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(PulmonaryVeins.q_in,conductor2.q_in) annotation(Line(points = {{46,24},{56,24},{56,0},{64,0}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(conductor2.q_out,bloodFlowOutflow) annotation(Line(points = {{84,0},{100,0}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(conductor2.cond,RvPulm.y) annotation(Line(points = {{74,6},{74,38},{73,38}}, color = {0,0,127}, smooth = Smooth.None));
      ...
      annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics={  Text(extent = {{-72,28},{76,18}}, lineColor = {0,0,255},
    ...
    model SystemicCirculation
      ...
      Physiolibrary.Types.Constants.PressureConst ExternalPressure(k = 0) annotation(Placement(transformation(extent = {{-4,-4},{4,4}}, rotation = 180, origin = {90,64})));
    ...
    equation
      ...
      connect(stressedVolume.y,SystemicStressedVolume) annotation(Line(points = {{-67,-82},{-62,-82},{-62,-80},{-50,-80}}, color = {0,0,127}, smooth = Smooth.None));
      connect(bloodVolume.y,SystemicBloodVolume) annotation(Line(points = {{23,-84},{40,-84}}, color = {0,0,127}, smooth = Smooth.None));
      connect(SystemicVeins.volume,bloodVolume.u1) annotation(Line(points = {{46,-10},{46,-68},{-4,-68},{-4,-76},{0,-76}}, color = {0,0,127}, smooth = Smooth.None));
      connect(SystemicArteries.volume,bloodVolume.u2) annotation(Line(points = {{-2,-10},{-2,-64},{-8,-64},{-8,-84},{0,-84}}, color = {0,0,127}, smooth = Smooth.None));
      connect(AortaProximal.volume,bloodVolume.u3) annotation(Line(points = {{-50,-10},{-50,-20},{-4,-20},{-4,-62},{-10,-62},{-10,-92},{0,-92}}, color = {0,0,127}, smooth = Smooth.None));
    ...
    model RightHeart
      ...
      GainConst RAAlpha(k = 0.04) annotation(Placement(transformation(extent = {{-92,84},{-84,90}})));
      GainConst RABeta(k = 0.3) annotation(Placement(transformation(extent = {{-80,80},{-72,86}})));
      Physiolibrary.Types.Constants.HydraulicElastanceConst RVEes(k = 50662507.2177) annotation(Placement(transformation(extent = {{14,90},{22,96}})));
      GainConst RVAlpha(k = 0.024) annotation(Placement(transformation(extent = {{2,84},{10,90}})));
      GainConst RVBeta(k = 0.34) annotation(Placement(transformation(extent = {{14,78},{22,84}})));
      ElasticVesselWithSVandP RightAtrium(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 4e-005) annotation(Placement(transformation(extent = {{-70,-10},{-50,10}})));
      ...
      ElasticVesselWithSVandP RightVentricle(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 6e-005) annotation(Placement(transformation(extent = {{30,-10},{50,10}})));
      ...
      Physiolibrary.Types.Constants.VolumeConst VRVU(k = 5e-006) annotation(Placement(transformation(extent = {{16,20},{24,28}})));
    ...
    equation
      ...
      connect(AEt0,AtrialElastance.Et0) annotation(Line(points = {{-93,71},{-72.5,71},{-72.5,76.06},{-51.36,76.06}}, color = {0,0,127}, smooth = Smooth.None));
      connect(VEt0,VentricularElastance.Et0) annotation(Line(points = {{7,67},{26.5,67},{26.5,76.06},{40.64,76.06}}, color = {0,0,127}, smooth = Smooth.None));
      connect(RAAlpha.y,AtrialElastance.Alpha) annotation(Line(points = {{-83,87},{-64,87},{-64,89.97},{-51.19,89.97}}, color = {0,0,127}, smooth = Smooth.None));
      connect(RABeta.y,AtrialElastance.Beta) annotation(Line(points = {{-71,83},{-61.5,83},{-61.5,85.94},{-51.36,85.94}}, color = {0,0,127}, smooth = Smooth.None));
      connect(VentricularElastance.Ees,RVEes.y) annotation(Line(points = {{40.81,92.83},{32,92.83},{32,93},{23,93}}, color = {0,0,127}, smooth = Smooth.None));
      connect(VentricularElastance.Alpha,RVAlpha.y) annotation(Line(points = {{40.81,89.97},{26,89.97},{26,87},{11,87}}, color = {0,0,127}, smooth = Smooth.None));
      connect(RVBeta.y,VentricularElastance.Beta) annotation(Line(points = {{23,81},{31.5,81},{31.5,85.94},{40.64,85.94}}, color = {0,0,127}, smooth = Smooth.None));
      ...
      connect(RightVentricle.StressedVolume,VentricularElastance.Vs) annotation(Line(points = {{32,-10.2},{22,-10.2},{22,-10},{2,-10},{2,74},{24,74},{24,78},{36,78},{36,82.3},{40.64,82.3}}, color = {0,0,127}, smooth = Smooth.None));
      ...
      connect(RightAtrium.StressedVolume,AtrialElastance.Vs) annotation(Line(points = {{-68,-10.2},{-78,-10.2},{-78,-10},{-96,-10},{-96,78},{-58,78},{-58,82.3},{-51.36,82.3}}, color = {0,0,127}, smooth = Smooth.None));
      connect(port_a,port_a) annotation(Line(points = {{-104,0},{-104,0}}, color = {0,0,0}, thickness = 1, smooth = Smooth.None));
      connect(RAEes.y,AtrialElastance.Ees) annotation(Line(points = {{-69,96},{-60,96},{-60,92.83},{-51.19,92.83}}, color = {0,0,127}, smooth = Smooth.None));
    ...
    model LeftHeart
      ...
      ElasticVesselWithSVandP LeftAtrium(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 4e-005) annotation(Placement(transformation(extent = {{-74,-10},{-54,10}})));
      ...
      ElasticVesselWithSVandP LeftVentricle(useV0Input = true, useComplianceInput = true, useExternalPressureInput = true, volume_start = 6e-005) annotation(Placement(transformation(extent = {{-6,-10},{14,10}})));
      ...
      HeartElastanceBurkhoff AtrialElastance annotation(Placement(transformation(extent = {{-52,64},{-10,94}})));
      HeartElastanceBurkhoff VentricularElastance annotation(Placement(transformation(extent = {{38,64},{78,94}})));
      GainConst LAAlpha(k = 0.04) annotation(Placement(transformation(extent = {{-100,78},{-92,86}})));
      GainConst LABeta(k = 0.3) annotation(Placement(transformation(extent = {{-100,66},{-92,74}})));
      GainConst LVAlpha(k = 0.024) annotation(Placement(transformation(extent = {{2,80},{12,88}})));
      GainConst LVBeta(k = 0.34) annotation(Placement(transformation(extent = {{0,68},{8,76}})));
      ...
      Physiolibrary.Types.Constants.VolumeConst VRAU(k = 5e-006) annotation(Placement(transformation(extent = {{-92,28},{-82,40}})));
      Physiolibrary.Types.Constants.VolumeConst VRVU(k = 5e-006) annotation(Placement(transformation(extent = {{-14,22},{-6,30}})));
      ...
      Physiolibrary.Types.Constants.HydraulicElastanceConst LAEes(k = 33330596.85375) annotation(Placement(transformation(extent = {{-96,90},{-88,98}})));
      Physiolibrary.Types.Constants.HydraulicElastanceConst LVEes(k = 205316476.6191) annotation(Placement(transformation(extent = {{2,94},{10,102}})));
    ...
    equation
      ...
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}, fillColor = {85,170,255},
...
"),
    ...
    model BloodVolume
      ...
      Physiolibrary.Types.RealIO.VolumeInput LeftHeartBloodVolume annotation(Placement(transformation(extent = {{-90,70},{-50,110}}), iconTransformation(extent = {{-12,-12},{12,12}}, rotation = 270, origin = {-32,92})));
    ...
    equation
      ...
      annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}, fillColor = {85,170,255},
    ...
    equation
      ...
      Et = (1 - Et0) * Beta * (exp(Alpha * Vs * 1000000.0) - 1) / (Vs * 1000000.0) * 133.322368 * 1000000.0 + Et0 * Ees;
  ...
  package Test
    model TestRightHeart "model of hemodynamics by Burkhoff in Physiolibrary"
      extends Physiolibrary.Icons.RightHeart;
      Parts.RightHeart rightHeart annotation(Placement(transformation(extent = {{-46,-36},{-6,6}})));
    ...
    equation
      connect(RAAlpha.y,AtrialElastance.Alpha) annotation(Line(points = {{3,61},{22,61},{22,63.97},{34.81,63.97}}, color = {0,0,127}, smooth = Smooth.None));
      connect(RABeta.y,AtrialElastance.Beta) annotation(Line(points = {{15.5,56},{24.5,56},{24.5,59.94},{34.64,59.94}}, color = {0,0,127}, smooth = Smooth.None));
      connect(RAEes.y,AtrialElastance.Ees) annotation(Line(points = {{17,70},{26,70},{26,66.83},{34.81,66.83}}, color = {0,0,127}, smooth = Smooth.None));
      connect(ramp.y,AtrialElastance.Vs) annotation(Line(points = {{-49,10},{-12,10},{-12,48},{30,48},{30,56.3},{34.64,56.3}}, color = {0,0,127}, smooth = Smooth.None));
      connect(AEt0.y,AtrialElastance.Et0) annotation(Line(points = {{21.5,37},{21.5,43.5},{34.64,43.5},{34.64,50.06}}, color = {0,0,127}, smooth = Smooth.None));
      annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics = {Text(extent=  {{-112,60},{-54,38}}, lineColor=  {0,0,255}, fillColor=  {85,170,255}, fillPattern=  FillPattern.Solid, textString=  "AEt0"),Text(extent=  {{-62,60},{-4,38}}, lineColor=  {0,0,255}, fillColor=  {85,170,255}, fillPattern=  FillPattern.Solid, textString=  "VEt0"),Text(extent=  {{-16,60},{42,38}}, lineColor=  {0,0,255}, fillColor=  {85,170,255}, fillPattern=  FillPattern.Solid, textString=  "PTH"),Text(extent=  {{-76,-34},{26,-60}}, lineColor=  {0,0,255}, fillColor=  {85,170,255}, fillPattern=  FillPattern.Solid, textString=  "AVGain"),Text(extent=  {{-84,-84},{-42,-94}}, lineColor=  {0,0,255}, fillColor=  {85,170,255}, fillPattern=  FillPattern.Solid, textString=  "Volume"),Text(extent=  {{-20,-84},{40,-92}}, lineColor=  {0,0,255}, fillColor=  {85,170,255}, fillPattern=  FillPattern.Solid, textString=  "Stressed Volume")}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics));
    end TestElastance;
    ...
    model TestLeftHeart "model of hemodynamics by Burkhoff in Physiolibrary"
      extends Physiolibrary.Icons.CardioVascular;
      Parts.LeftHeart leftHeart annotation(Placement(transformation(extent = {{-14,-36},{28,4}})));
      Parts.HeartElasticities heartElasticities annotation(Placement(transformation(extent = {{-76,10},{-54,30}})));
      Physiolibrary.Types.Constants.PressureConst PTH(k = 0) annotation(Placement(transformation(extent = {{-62,36},{-54,44}})));
