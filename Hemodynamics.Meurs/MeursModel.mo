...
package MeursModel
  package Parts
    ...
    equation
      ...
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics={  Text(fillColor = {255, 85, 85},
                fillPattern =                                                                                                    FillPattern.Solid, extent = {{-82, 40}, {50, 18}}, textString = "Peripheral resistance"), Text(lineColor = {0, 0, 255}, fillColor = {255, 85, 85},
                fillPattern =                                                                                                    FillPattern.Solid, extent = {{-92, -40}, {102, -62}}, textString = "%name")}));
    ...
    equation
      ...
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics={  Text(lineColor = {0, 0, 255}, fillColor = {255, 170, 213},
                ...
                fillPattern =                                                                                                    FillPattern.Solid, extent = {{88, 24}, {-84, 66}}, textString = "IntraThoracic pressure")}));
  ...
  package Test
    ...
    equation
      ...
      connect(rightHeart.outflow, unlimitedVolume1.y) annotation(Line(points = {{16, 28.14}, {30, 28.14}, {30, 44}, {44, 44}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
      connect(unlimitedPump.q_out, rightHeart.inflow) annotation(Line(points = {{-44, -40}, {3.5, -40}, {3.5, 9}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
    ...
    equation
      connect(systemicVeins.bloodFlowInflow, systemicPeripheralVessels1.bloodFlowOutflow) annotation(Line(points = {{-18, 7.24}, {-16, 7.24}, {-8.609999999999999, 5.68}, {-8.609999999999999, 5.64}}, thickness = 1));
    ...
    model HemodynamicsTest4
      ...
      Physiolibrary.Types.Constants.HydraulicResistanceConst hydraulicresistance(k(displayUnit = "(mmHg.s)/ml") = 106657909.932) annotation(Placement(transformation(extent = {{-2, 34}, {6, 42}})));
      Parts.SystemicVeins systemicVeins annotation(Placement(transformation(extent = {{-50, -2}, {-18, 26}})));
      OldParts.RightHeart rightHeart annotation(Placement(transformation(extent = {{-30, 46}, {14, 100}})));
    ...
    equation
      ...
      connect(pressure.y, pulmonaryCirculation.intrathoracicPressure) annotation(Line(points = {{-79, 94}, {-36, 94}, {-36, 108.1}, {8.1, 108.1}}, color = {0, 0, 127}, smooth = Smooth.None));
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics));
    ...
    model TestPump
      Physiolibrary.Hydraulic.Components.Pump pump(SolutionFlow = 8.333333333333301e-005) annotation(Placement(transformation(extent = {{-18, 2}, {2, 22}})));
      Physiolibrary.Hydraulic.Sources.UnlimitedVolume unlimitedVolume annotation(Placement(transformation(extent = {{-78, 0}, {-58, 20}})));
      Tank tank annotation(Placement(transformation(extent = {{14, -18}, {34, 2}})));
    equation
      connect(unlimitedVolume.y, pump.q_in) annotation(Line(points = {{-58, 10}, {-38, 10}, {-38, 12}, {-18, 12}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
      connect(pump.q_out, tank.hydraulicPort) annotation(Line(points = {{2, 12}, {12, 12}, {12, -8}, {19.2, -8}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.None));
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics));
    end TestPump;

    model Tank
      Physiolibrary.Types.Volume volume(start = 0, fixed = true);
      Physiolibrary.Hydraulic.Interfaces.HydraulicPort hydraulicPort annotation(Placement(transformation(extent = {{-58, -10}, {-38, 10}}), iconTransformation(extent = {{-58, -10}, {-38, 10}})));
    equation
      der(volume) = hydraulicPort.q;
      hydraulicPort.pressure = 0;
      annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent=  {{-38, 8}, {38, -52}}, lineColor=  {0, 0, 0}, fillColor=  {58, 117, 175}, fillPattern=  FillPattern.VerticalCylinder, lineThickness=  1), Rectangle(extent=  {{-38, 58}, {38, 8}}, lineColor=  {0, 0, 0})}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics));
    end Tank;
  end Test;
  ...
  package Models
    ...
    equation
      ...
      connect(rightHeart.outflow, pulmonaryCirculation.bloodFlowInflow) annotation(Line(points = {{-10, 25.7}, {-20, 25.7}, {-20, 26}, {-32, 26}, {-32, 74}, {-4, 74}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.Bezier));
      connect(pulmonaryCirculation.bloodflowOutflow, leftHeart.inflow) annotation(Line(points = {{16, 74}, {32, 74}, {32, 10.14}, {17.6, 10.14}}, color = {0, 0, 0}, thickness = 1, smooth = Smooth.Bezier));
      ...
      connect(pulmonaryCirculation.intrathoracicPressure, Pth.y) annotation(Line(points = {{6.1, 80.09999999999999}, {6.1, 82}, {34, 82}, {34, -16}, {16, -16}, {16, -24}, {19, -24}}, color = {0, 0, 127}, smooth = Smooth.None));
