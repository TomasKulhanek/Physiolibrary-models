...
package GlucoseInsulin
  package Components
    ...
    equation
      ...
      annotation (
        Icon(graphics={  Polygon(origin = {9, -3}, fillColor = {114, 159, 207},
                fillPattern =                                                                 FillPattern.Solid, points = {{-83, 63}, {-85, 63}, {-81, -53}, {-73, -61}, {-51, -61}, {69, -61}, {79, -61}, {83, -51}, {83, -41}, {85, 61}, {85, 61}, {-83, 63}}, smooth = Smooth.Bezier), Text(origin = {0, -80}, extent = {{-140, 20}, {140, -20}}, textString = "%name"), Text(extent = {{-242, -100}, {260, -142}}, lineColor = {0, 0, 0}, textString = "%desiredVolume")}, coordinateSystem(initialScale = 0.1)));
    end VolumeConst;
  ...
  Connector with one output signal of type Real.
    ...
    connector MassFlow
      ...
      annotation (
        Icon(graphics={  Polygon(lineColor = {173, 127, 168}, fillColor = {173, 127, 168},
                fillPattern =                                                                            FillPattern.Solid,
                lineThickness =                                                                                                             1, points = {{0, 100}, {-100, 0}, {0, -100}, {100, 0}, {0, 100}})}));
    end MassFlow;
